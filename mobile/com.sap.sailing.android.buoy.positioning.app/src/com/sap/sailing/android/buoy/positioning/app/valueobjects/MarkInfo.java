...
public class MarkInfo extends MarkImpl {
    ...
    public static MarkInfo create(Mark mark, String classname, String checkinDigest) {
        return new MarkInfo(mark.getId(), mark.getName(), mark.getType(), mark.getColor(), mark.getShape(),
                mark.getPattern(), classname, checkinDigest);
    }
    ...
    public MarkInfo(Serializable id, String name, MarkType type, Color color, String shape, String pattern,
            String classname, String checkinDigest) {
