...
public abstract class AbstractHomeFragment extends BaseFragment {
	...
	private void showNoQRCodeMessage() {
		((AbstractStartActivity) getActivity()).showErrorPopup(
				R.string.no_qr_code_popup_title,
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		if (resultCode == Activity.RESULT_OK) {
			...
			Toast.makeText(getActivity(),
					getString(R.string.scanning_cancelled), Toast.LENGTH_LONG)
					.show();
		} else {
			String templateString = getString(R.string.error_scanning_qrcode);
			Toast.makeText(
					getActivity(),
					templateString.replace("{result-code}",
	 ...
	 * @param checkinData
	 */
	public abstract void displayUserConfirmationScreen(
			final AbstractCheckinData data);
