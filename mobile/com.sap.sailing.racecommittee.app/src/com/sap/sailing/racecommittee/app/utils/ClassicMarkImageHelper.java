...
public class ClassicMarkImageHelper extends MarkImageHelper {
    private static ClassicMarkImageHelper instance = null;

    private ClassicMarkImageHelper() {
    ...
    public static ClassicMarkImageHelper getInstance() {
        if (instance == null) {
            instance = new ClassicMarkImageHelper();
        }
        return instance;
    }    
