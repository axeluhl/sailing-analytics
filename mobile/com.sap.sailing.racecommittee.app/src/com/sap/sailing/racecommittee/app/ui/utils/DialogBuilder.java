...
public class DialogBuilder extends AlertDialog.Builder {
     ...
     * @param color               The color to tint the icon, title, divider, progress-bar, etc.
     * @param setIconColor        {@code true} to set a ColorFilter on the title icon color.
     * @param setTitleColor       {@code true} to set the text color on the title.
     * @param setDividerColor     {@code true} to set the color for the title divider.
     * @param setProgressBarColor {@code true} to set the color for the horizontal progress bar.
     */
    public static void showColoredDialog(Dialog dialog, final int color, final boolean setIconColor,
        final boolean setTitleColor, final boolean setDividerColor, final boolean setProgressBarColor) {
        if (!dialog.isShowing()) {
            dialog.show();
        }
        if (setIconColor) {
    ...
    public static void setIconColor(Dialog dialog, final int color) {
        ...
        if (color != -1) {
            final int iconId = dialog.getContext().getResources().getIdentifier("android:id/icon", null, null);
            if (iconId != 0) {
    ...
    @Override
    public DialogBuilder setCursor(Cursor cursor, final OnClickListener listener, final String labelColumn) {
    ...
    @Override
    public DialogBuilder setMultiChoiceItems(CharSequence[] items, final boolean[] checkedItems,
        final OnMultiChoiceClickListener listener) {
    ...
    @Override
    public DialogBuilder setMultiChoiceItems(Cursor cursor, final String isCheckedColumn, final String labelColumn,
        final OnMultiChoiceClickListener listener) {
    ...
    @Override
    public DialogBuilder setSingleChoiceItems(int itemsId, final int checkedItem, final OnClickListener listener) {
        super.setSingleChoiceItems(itemsId, checkedItem, listener);
        return this;
    }

    @Override
    public DialogBuilder setSingleChoiceItems(Cursor cursor, final int checkedItem, final String labelColumn,
    ...
    /**
     * @param iconColor The color for the title icon.
     * @return This Builder object to allow for chaining of calls to set methods
     */
    ...
    /**
     * @param progressBarColor The color for the progressbar.
     * @return This Builder object to allow for chaining of calls to set methods
     */
