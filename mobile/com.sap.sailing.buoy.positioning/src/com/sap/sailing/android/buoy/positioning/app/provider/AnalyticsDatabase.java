...
public class AnalyticsDatabase extends SQLiteOpenHelper {
    ...
    interface Tables {
        ...
        String MARKS_LEADERBOARDS_JOINED =
            "marks LEFT JOIN leaderboards ON (" + Tables.MARKS + "." + Mark.MARK_CHECKIN_DIGEST + " = "
                + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " )";

        String LEADERBOARDS_MARKS_JOINED =
            "leaderboards LEFT JOIN marks ON (" + Tables.MARKS + "." + Mark.MARK_CHECKIN_DIGEST + " = "
                + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " )";
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
            "CREATE TABLE " + Tables.LEADERBOARDS + " (" + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + LeaderboardColumns.LEADERBOARD_CHECKIN_DIGEST + " TEXT, " + LeaderboardColumns.LEADERBOARD_SERVER_URL
                + " TEXT, " + LeaderboardColumns.LEADERBOARD_NAME + " TEXT );");
        ...
        db.execSQL("CREATE TABLE " + Tables.MARK_PINGS + " (" + BaseColumns._ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
            + MarkPingColumns.MARK_ID + " INTEGER," + MarkPingColumns.MARK_PING_TIMESTAMP + " TEXT,"
            + MarkPingColumns.MARK_PING_LATITUDE + " TEXT," + MarkPingColumns.MARK_PING_LONGITUDE + " TEXT,"
