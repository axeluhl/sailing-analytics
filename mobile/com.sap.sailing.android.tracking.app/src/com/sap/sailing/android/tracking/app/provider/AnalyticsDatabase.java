...
public class AnalyticsDatabase extends SQLiteOpenHelper {
    ...
    private static final String createMarkTable = "CREATE TABLE " + Tables.MARKS + " (" + BaseColumns._ID
            ...
            + AnalyticsContract.Mark.MARK_NAME + " TEXT, " + AnalyticsContract.Mark.MARK_CHECKIN_DIGEST + " TEXT);";

    private static final String createBoatTable = "CREATE TABLE " + Tables.BOATS + " (" + BaseColumns._ID
            + " INTEGER PRIMARY KEY AUTOINCREMENT, " + AnalyticsContract.Boat.BOAT_ID + " TEXT, "
            + AnalyticsContract.Boat.BOAT_NAME + " TEXT, " + AnalyticsContract.Boat.BOAT_CHECKIN_DIGEST + " TEXT,"
    ...
    public interface Tables {
        ...
        String EVENTS_JOIN_LEADERBOARDS_JOIN_MARKS = Tables.LEADERBOARDS + " INNER JOIN " + Tables.EVENTS + " ON ("
                + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " = " + Tables.EVENTS + "."
                + Event.EVENT_CHECKIN_DIGEST + ") " + " INNER JOIN " + Tables.MARKS + " ON (" + Tables.LEADERBOARDS
                + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " = " + Tables.MARKS + "."
        ...
        String LEADERBOARDS_JOIN_EVENTS_JOIN_COMPETITORS_JOIN_MARKS_JOINS_BOATS = Tables.LEADERBOARDS + " INNER JOIN "
                + Tables.EVENTS + " ON (" + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " = "
                + Tables.EVENTS + "." + Event.EVENT_CHECKIN_DIGEST + ") " + " INNER JOIN " + Tables.CHECKIN_URIS
                + " ON (" + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " = "
                + Tables.CHECKIN_URIS + "." + Checkin.CHECKIN_URI_CHECKIN_DIGEST + ") " + " LEFT OUTER JOIN "
                + Tables.COMPETITORS + " ON (" + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST
                + " = " + Tables.COMPETITORS + "." + Competitor.COMPETITOR_CHECKIN_DIGEST + ") " + " LEFT OUTER JOIN "
                + Tables.MARKS + " ON (" + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " = "
                + Tables.MARKS + "." + AnalyticsContract.Mark.MARK_CHECKIN_DIGEST + ") " + " LEFT OUTER JOIN "
                + Tables.BOATS + " ON (" + Tables.LEADERBOARDS + "." + Leaderboard.LEADERBOARD_CHECKIN_DIGEST + " = "
                + Tables.BOATS + "." + AnalyticsContract.Boat.BOAT_CHECKIN_DIGEST + ") ";
    }
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            db.execSQL("CREATE TABLE " + Tables.LEADERBOARDS + " (" + BaseColumns._ID
                    ...
                    + LeaderboardColumns.LEADERBOARD_NAME + " TEXT, " + LeaderboardColumns.LEADERBOARD_DISPLAY_NAME
                    + " TEXT);");
            ...
            db.execSQL("CREATE TABLE " + Tables.CHECKIN_URIS + " (" + BaseColumns._ID
                    ...
                    + CheckinColumns.CHECKIN_URI_VALUE + " TEXT, " + CheckinColumns.CHECKIN_TYPE + " INTEGER );");
            ...
            db.execSQL("CREATE TABLE " + Tables.EVENTS + " ( " + BaseColumns._ID
                    + " INTEGER PRIMARY KEY AUTOINCREMENT, " + EventColumns.EVENT_ID + " TEXT, "
                    + EventColumns.EVENT_NAME + " TEXTL, " + EventColumns.EVENT_DATE_START + " INTEGER, "
                    + EventColumns.EVENT_DATE_END + " INTEGER, " + EventColumns.EVENT_SERVER + " TEXT, "
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        try {
            if (oldVersion < 2) {
                db.execSQL(createMarkTable);
                db.execSQL("ALTER TABLE " + Tables.CHECKIN_URIS + " ADD COLUMN " + Checkin.CHECKIN_TYPE
                        + " INTEGER DEFAULT 0");
            }
            if (oldVersion < 3) {
