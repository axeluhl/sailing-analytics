...
As of 2019-01-28 we have been removed from the SES sandbox and can now deliver e-mail also to addresses that have not been validated on SES before. Our current limits are 200,000 messages per day and 100 messages per second.
