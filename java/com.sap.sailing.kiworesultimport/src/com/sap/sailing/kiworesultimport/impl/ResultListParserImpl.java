...
public class ResultListParserImpl implements ResultListParser {
    ...
    @Override
    public ResultList parse(InputStream inputStream) throws SAXException, IOException, ParserConfigurationException {
        Document doc = parseDocument(inputStream);
        ResultList result = new ResultListImpl(doc.getElementsByTagName("ResultList").item(0));
        return result;
    }
