...
public class TagDTODeSerializerTest {
    ...
    public void testSerializeSingleTag() {
        ...
        final TagDTO tag = new TagDTO(title, comment, imageURL, false, username, raceTimePoint, createdAt);
        final TagDTO revokedTag = new TagDTO(title, comment, imageURL, false, username, raceTimePoint, createdAt,
                revokedAt);
        ...
        assertEquals("imageURL equals serialized imageURL", imageURL, tagJson.get(TagDTODeSerializer.FIELD_IMAGE_URL));
    ...
    public void testSerializeMultipleTags() {
        ...
        final TagDTO tag1 = new TagDTO(title + "1", comment, imageURL, false, username, raceTimePoint, createdAt);
        final JSONObject tag1Json = serializer.serialize(tag1);
        final TagDTO tag2 = new TagDTO(title + "2", comment, imageURL, true, username, raceTimePoint, createdAt,
                revokedAt);
    ...
    public void testDeserializeSingleTag() {
        ...
        final TimePoint createdAt = MillisecondsTimePoint.now();
        final TimePoint revokedAt = new MillisecondsTimePoint(5678);
        final TagDTO tag = new TagDTO(title, comment, imageURL, visibileForPublic, username, raceTimePoint, createdAt,
                revokedAt);
        ...
        tagJson.put(TagDTODeSerializer.FIELD_IMAGE_URL, imageURL);
    ...
    public void testDeserializeMultipleTags() {
        ...
        final TimePoint createdAt = MillisecondsTimePoint.now();
        final TimePoint revokedAt = new MillisecondsTimePoint(5678);
        final TagDTO tag1 = new TagDTO(title + "1", comment, imageURL, visibileForPublic, username, raceTimePoint,
                createdAt, revokedAt);
        final TagDTO tag2 = new TagDTO(title + "2", comment, imageURL, visibileForPublic, username, raceTimePoint,
                createdAt, revokedAt);
        ...
        tag1Json.put(TagDTODeSerializer.FIELD_IMAGE_URL, imageURL);
        tag2Json.put(TagDTODeSerializer.FIELD_IMAGE_URL, imageURL);
