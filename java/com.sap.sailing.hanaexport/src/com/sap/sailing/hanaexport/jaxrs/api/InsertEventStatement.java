...
public class InsertEventStatement extends AbstractPreparedInsertStatement<Event> {
    ...
    public void parameterizeStatement(Event event) throws SQLException {
        ...
        getPreparedStatement().setString(8, location != null ? String.format("new ST_GEOMETRY(POINT(%1.8f %1.8f), 4326).ST_Transform(3857)", location.getLatDeg(), location.getLngDeg()) : null);
    }
}
