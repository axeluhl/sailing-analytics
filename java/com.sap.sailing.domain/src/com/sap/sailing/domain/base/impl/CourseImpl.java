...
public class CourseImpl extends NamedImpl implements Course {
    ...
    @Override
    public void update(Iterable<Pair<ControlPoint, PassingInstructions>> newControlPoints, DomainFactory baseDomainFactory) throws PatchFailedException {
        ...
        synchronized (updateMonitor) {
            ...
            try {
                ...
                for (Pair<ControlPoint, PassingInstructions> newDomainControlPoint : newControlPoints) {
