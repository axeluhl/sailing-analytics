...
public enum BoatClassMasterdata {
    _2_4M ("2.4 Meter", true, 4.11, 0.81, BoatHullType.MONOHULL, "2.4M", "2.4mR", "2.4M", "24M"),
    ...
    _420 ("420", true, 4.20, 1.65, BoatHullType.MONOHULL),
    ...
    F_18 ("F 18", false, 6.85, 2.25, BoatHullType.MONOHULL, "F-18"),
    ...
    LASER_SB3 ("Laser SB3", true, 6.15, 2.15, BoatHullType.MONOHULL, "LSB3"),
    ...
    RS_X ("RS:X", true, 2.86, 0.93, BoatHullType.MONOHULL, "RS-X", "RSX"),
    ...
    //TODO: which boatclass of swan is important (there are several ones)
