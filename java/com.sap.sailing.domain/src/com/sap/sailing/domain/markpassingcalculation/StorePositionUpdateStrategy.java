...
public interface StorePositionUpdateStrategy {
     ...
     */
    void storePositionUpdate(Map<Competitor, List<GPSFix>> competitorFixes, Map<Mark, List<GPSFix>> markFixes, List<Waypoint> newWaypoints, List<Waypoint> removedWaypoints);
}
