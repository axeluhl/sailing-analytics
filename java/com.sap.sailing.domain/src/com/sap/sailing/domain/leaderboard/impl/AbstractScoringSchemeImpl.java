...
public abstract class AbstractScoringSchemeImpl implements ScoringScheme {
     ...
     */
    @Override
    public int compareByBetterScore(List<com.sap.sse.common.UtilNew.Pair<RaceColumn, Double>> o1Scores, List<com.sap.sse.common.UtilNew.Pair<RaceColumn, Double>> o2Scores, boolean nullScoresAreBetter) {
        ...
        for (com.sap.sse.common.UtilNew.Pair<RaceColumn, Double> o1ColumnAndScore : o1Scores) {
            o1NetScores.add(o1ColumnAndScore.getB()/o1ColumnAndScore.getA().getFactor());
        }
        List<Double> o2NetScores = new ArrayList<>();
        for (com.sap.sse.common.UtilNew.Pair<RaceColumn, Double> o2ColumnAndScore : o2Scores) {
    ...
    @Override
    public int compareByLastRace(List<com.sap.sse.common.UtilNew.Pair<RaceColumn, Double>> o1Scores, List<com.sap.sse.common.UtilNew.Pair<RaceColumn, Double>> o2Scores, boolean nullScoresAreBetter) {
        int result = 0;
