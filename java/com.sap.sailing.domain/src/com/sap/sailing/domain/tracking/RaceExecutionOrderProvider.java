...
/**
 * Sometimes {@link TrackedRace}s want to know which {@link DynamicTrackedRace} is in front of them in the execution order
...
public interface RaceExecutionOrderProvider {
     ...
     */
    Set<TrackedRace> getPreviousRacesInExecutionOrder(TrackedRace race);
