...
/**
 * Starts out in state {@link Status#PREPARED} with loading progress 0.0.
 * 
...
public class TrackedRaceStatusImpl implements TrackedRaceStatus {
    ...
    private final TrackedRaceStatus.Status status;
    private final double loadingProgress;
    
    public TrackedRaceStatusImpl(Status status, double loadingProgress) {
        super();
        this.status = status;
