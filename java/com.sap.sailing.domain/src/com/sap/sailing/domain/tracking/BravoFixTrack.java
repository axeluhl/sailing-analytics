...
public interface BravoFixTrack<ItemType extends WithID & Serializable> extends SensorFixTrack<ItemType, BravoFix> {
    ...
    Double getExpeditionAWAIfAvailable(TimePoint timePoint);
    Double getExpeditionAWSIfAvailable(TimePoint timePoint);
    Double getExpeditionTWAIfAvailable(TimePoint timePoint);
    Double getExpeditionTWSIfAvailable(TimePoint timePoint);
    Double getExpeditionTWDIfAvailable(TimePoint timePoint);
    Double getExpeditionTargTWAIfAvailable(TimePoint timePoint);
    Double getExpeditionBoatSpeedIfAvailable(TimePoint timePoint);
    Double getExpeditionTargBoatSpeedIfAvailable(TimePoint timePoint);
    Double getExpeditionSOGIfAvailable(TimePoint timePoint);
    Double getExpeditionCOGIfAvailable(TimePoint timePoint);
    Double getExpeditionForestayLoadIfAvailable(TimePoint timePoint);
    Double getExpeditionRakeIfAvailable(TimePoint timePoint);
    Double getExpeditionCourseDetailIfAvailable(TimePoint timePoint);
    Double getExpeditionHeadingIfAvailable(TimePoint timePoint);
    Double getExpeditionVMGIfAvailable(TimePoint timePoint);
    Double getExpeditionVMGTargVMGDeltaIfAvailable(TimePoint timePoint);
    Double getExpeditionRateOfTurnIfAvailable(TimePoint timePoint);
    Double getExpeditionRudderAngleIfAvailable(TimePoint timePoint);
    Double getExpeditionHeelIfAvailable(TimePoint timePoint);
    Double getExpeditionTargetHeelIfAvailable(TimePoint timePoint);
    Double getExpeditionTimeToPortLaylineIfAvailable(TimePoint timePoint);
    Double getExpeditionTimeToStbLaylineIfAvailable(TimePoint timePoint);
    Double getExpeditionDistToPortLaylineIfAvailable(TimePoint timePoint);
    Double getExpeditionDistToStbLaylineIfAvailable(TimePoint timePoint);
    Duration getExpeditionTimeToGUNIfAvailable(TimePoint timePoint);
    Double getExpeditionTimeToCommitteeBoatIfAvailable(TimePoint timePoint);
    Double getExpeditionTimeToPinIfAvailable(TimePoint timePoint);
    Duration getExpeditionTimeToBurnToLineIfAvailable(TimePoint timePoint);
    Double getExpeditionTimeToBurnToCommitteeBoatIfAvailable(TimePoint timePoint);
    Double getExpeditionTimeToBurnToPinIfAvailable(TimePoint timePoint);
    Double getExpeditionDistanceTocommitteeBoatIfAvailable(TimePoint timePoint);
    Double getDistanceToPinDetailIfAvailable(TimePoint timePoint);
    Double getDistanceBelowLineIfAvailable(TimePoint timePoint);
    Double getLineSquareForWindIfAvailable(TimePoint timePoint);
}
