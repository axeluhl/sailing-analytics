...
public interface BravoFixTrack<ItemType extends WithID & Serializable> extends SensorFixTrack<ItemType, BravoFix> {
    ...
    Double getExpeditionAWAIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionAWSIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTWAIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTWSIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTWDIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTargTWAIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionBoatSpeedIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTargBoatSpeedIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionSOGIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionCOGIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionForestayLoadIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionRakeIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionCourseDetailIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionHeadingIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionVMGIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionVMGTargVMGDeltaIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionRateOfTurnIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionRudderAngleIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionHeelIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTargetHeelIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTimeToPortLaylineIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTimeToStbLaylineIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionDistToPortLaylineIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionDistToStbLaylineIfAvailable(TimePoint start, TimePoint endTimePoint);
    Duration getExpeditionTimeToGUNIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTimeToCommitteeBoatIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getExpeditionTimeToPinIfAvailable(TimePoint start, TimePoint endTimePoint);
