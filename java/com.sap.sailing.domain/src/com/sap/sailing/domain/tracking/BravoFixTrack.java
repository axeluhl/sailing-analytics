...
public interface BravoFixTrack<ItemType extends WithID & Serializable> extends SensorFixTrack<ItemType, BravoFix> {
    ...
    Double getAverageExpeditionTimeToGUNIfAvailable(TimePoint start, TimePoint endTimePoint);
    ...
    Double getAverageExpeditionTimeToBurnToLineIfAvailable(TimePoint start, TimePoint endTimePoint);
