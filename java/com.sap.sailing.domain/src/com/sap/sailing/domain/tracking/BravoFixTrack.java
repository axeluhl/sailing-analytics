...
public interface BravoFixTrack<ItemType extends WithID & Serializable> extends SensorFixTrack<ItemType, BravoFix> {
    ...
    Duration getAverageExpeditionTimeToGUNIfAvailable(TimePoint start, TimePoint endTimePoint);
    ...
    Duration getAverageExpeditionTimeToBurnToLineIfAvailable(TimePoint start, TimePoint endTimePoint);
    ...
    Double getAverageDistanceToPinDetailIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getAverageDistanceBelowLineIfAvailable(TimePoint start, TimePoint endTimePoint);
    Double getAverageLineSquareForWindIfAvailable(TimePoint start, TimePoint endTimePoint);
}
