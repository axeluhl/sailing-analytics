...
public interface TrackedRaceStatus extends Serializable {
    public static enum Status { PREPARED, LOADING, TRACKING, FINISHED };
    
    Status getStatus();
    
    /**
     * Particularly interesting when the {@link #getStatus() status} is {@link Status#LOADING}. Indicates the progress
     ...
     *         1.0 will, however, hardly be seen in state {@link Status#LOADING} because the status will probably
     *         already have transitioned to {@link Status#TRACKING} or {@link Status#FINISHED}.
     */
