...
public interface DynamicTrack<FixType extends Timed> extends Track<FixType> {
    /**
     * Tries to add {@code fix} to this track. If an {@link #equals(Object) equal} fix already exists
     * in this track, the track remains unchanged and {@code false} will be returned.
     * 
    ...
    /**
     * Tries to add {@code fix} to this track. If an {@link #equals(Object) equal} fix already exists
     * in this track and {@code replace} is {@code false}, the track remains unchanged and {@code false} will be returned.
     * If {@code replace} is {@code true}, an equal (by definition of the comparator used for the fixes set) fix will
     * replace the fix contained in this track.
     * 
     * @param replace
