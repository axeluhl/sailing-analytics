...
public class WindRange {
    ...
    public WindRange(double windCourseOnPortsideBoundary,
            double windCourseDeviationTowardStarboardInDegrees, double secondsPassedSincePortsideBoundaryRecord,
            double secondsPassedSinceStarboardBoundaryRecord) {
    ...
    public WindRange calculateForNextManeuverNodesLevel(double nextWindCourse,
        ...
        if (deviationFromRecordedWindCourseDeviationTowardStarboardInDegrees <= 0) {
            ...
            return new WindRange(windCourseOnPortsideBoundary,
                    windCourseDeviationTowardStarboardInDegrees,
