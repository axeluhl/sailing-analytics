...
/**
 * Feature transformation. In general, learning algorithms benefit from standardization of the data set. If some
 * outliers are present in the set, robust transformers are more appropriate.
 *
 * @author Haifeng Li
 */
...
public abstract class FeatureTransform implements Serializable { //original class is not Serializable
     ...
     * 
     * @param attributes
     *            The variable attributes. Of which, numeric variables will be standardized.
     * @param data
     *            The training data to learn scaling parameters. The data will not be modified.
     */
     ...
     * 
     * @param x
     *            an array of feature vectors. The feature vectors may be modified on output if copy is false.
