...
public abstract class AbstractDataRetrieverChainDefinition<DataSourceType, DataType, Settings extends com.sap.sse.common.settings.Settings> implements
        DataRetrieverChainDefinition<DataSourceType, DataType, Settings> {
    ...
    public AbstractDataRetrieverChainDefinition(Class<DataSourceType> dataSourceType, Class<DataType> retrievedDataType, String nameMessageKey) {
        id = UUID.randomUUID();
    ...
    public AbstractDataRetrieverChainDefinition(DataRetrieverChainDefinition<DataSourceType, ?, ?> dataRetrieverChainDefinition, Class<DataType> retrievedDataType, String nameMessageKey) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        AbstractDataRetrieverChainDefinition<?, ?, ?> other = (AbstractDataRetrieverChainDefinition<?, ?, ?>) obj;
