...
public class IgtimiWindTracker extends AbstractWindTracker implements WindTracker {
    ...
    private final Map<LiveDataConnection, UtilNew.Pair<Iterable<String>, Account>> liveConnectionsAndDeviceSerialNumber;
                        ...
                        try {
                            if (!stopping) {
                                ...
                                if (!stopping) {
                                    ...
                                    liveConnectionsAndDeviceSerialNumber.put(liveConnection, new UtilNew.Pair<Iterable<String>, Account>(devicesWeShouldListenTo, account));
                                }
                            }
                        } catch (Exception e) {
        ...
        synchronized (this) {
            ...
            for (LiveDataConnection ldc : liveConnectionsAndDeviceSerialNumber.keySet()) {
                try {
                    ...
                    final UtilNew.Pair<Iterable<String>, Account> deviceSerialNumberAndAccount = liveConnectionsAndDeviceSerialNumber.get(ldc);
