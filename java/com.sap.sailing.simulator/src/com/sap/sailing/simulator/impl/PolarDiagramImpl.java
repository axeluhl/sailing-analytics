...
public class PolarDiagramImpl implements PolarDiagram {
    ...
    public SpeedWithBearing getSpeedAtBearing(Bearing bearing) {
        if (bearing.equals(northEast) || bearing.equals(northWest))
            return new KilometersPerHourSpeedWithBearingImpl(wind.getKilometersPerHour(), bearing);
        if (bearing.equals(southEast) || bearing.equals(southWest))
            return new KilometersPerHourSpeedWithBearingImpl(0.7 * wind.getKilometersPerHour(), bearing);
