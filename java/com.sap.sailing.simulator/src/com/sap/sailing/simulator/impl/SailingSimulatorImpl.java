...
public class SailingSimulatorImpl implements SailingSimulator {
    ...
    // this.simulationParameters.getBoatPolarDiagram().setCurrent(new
    // KnotSpeedWithBearingImpl(wf.getWindParameters().curSpeed, new
    // DegreeBearingImpl(wf.getWindParameters().curBearing)));
    ...
    //
    // // evaluate opportunistic heuristic
    // PathGeneratorOpportunistEuclidian genOpportunistic = new
    // PathGeneratorOpportunistEuclidian(this.simulationParameters);
    // // PathGeneratorOpportunistVMG genOpportunistic = new PathGeneratorOpportunistVMG(simulationParameters);
    //
    // // left-starting opportunist
    // genOpportunistic.setEvaluationParameters(left1TurnMiddle, right1TurnMiddle, true);
    ...
    // if (plausCheck) {
    // if (leftPath.getPathPoints() != null) {
    // if (leftPath.getPathPoints().get(leftPath.getPathPoints().size() - 1).getTimePoint().asMillis() <=
    // optPath.getPathPoints().get(optPath.getPathPoints().size() - 1).getTimePoint()
    // .asMillis()) {
    // optPath = leftPath;
    // }
    // }
    //
    // if (rightPath.getPathPoints() != null) {
    // if (rightPath.getPathPoints().get(rightPath.getPathPoints().size() - 1).getTimePoint().asMillis() <=
    // optPath.getPathPoints().get(optPath.getPathPoints().size() - 1).getTimePoint()
    // .asMillis()) {
    // optPath = rightPath;
    // }
    ...
    //
    // if (oppPath != null) {
    // if (oppPath.getPathPoints().get(oppPath.getPathPoints().size() - 1).getTimePoint().asMillis() <=
    // optPath.getPathPoints().get(optPath.getPathPoints().size() - 1).getTimePoint()
    // .asMillis()) {
    // optPath = oppPath;
    // }
