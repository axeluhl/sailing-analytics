...
public class DomainObjectFactoryImpl implements DomainObjectFactory {
    ...
    public Iterable<SSHKeyPair> loadSSHKeyPairs() {
        ...
        for (Object o : keyPairCollection.find()) {
            ...
            final byte[] encryptedPrivateKey = privKey==null?null:privKey.getData();
            ...
            result.add(new SSHKeyPair(regionId, creatorName, TimePoint.of(creationDateMillis), name, publicKey, encryptedPrivateKey));
        }
        return result;
    }
}
