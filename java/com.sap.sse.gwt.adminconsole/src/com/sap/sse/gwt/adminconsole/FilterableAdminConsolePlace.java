...
/**
 * Places that have filterable tables and should be filterable by URL parameters must implement this interface.
 * The panel that is rendered when the place is called must implement FilterablePanelProvider.
