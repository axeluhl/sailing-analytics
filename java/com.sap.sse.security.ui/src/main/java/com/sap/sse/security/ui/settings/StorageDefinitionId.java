...
/**
 * Represents the definition for User Settings and Document Settings storage keys,
 * which may be required by {@link SettingsStorageManager} implementations.
 * The storage keys determine the settings which will be loaded and stored in the
 * context of the currently opened entry point, or rather root perspective/component.
 * 
...
public class StorageDefinitionId {
    ...
    /**
     * Constructs the storage definition according to the provided identifications for
     * User Settings and Document Settings in the context of the currently opened
     * entry point.
     * 
     * @param globalId The storage key for User Settings, which is context independent
     * @param contextSpecificId The storage key for Document Settings, which is context dependent
     */
    ...
    /**
     * Gets the identification of User Settings for the currently opened entry point, or rather root perspective/component.
     * 
    ...
    /**
     * Gets the identification of Document Settings for the currently opened entry point, or rather root perspective/component,
     * <b>AND</b> the context which is viewed by root perspective/component
     * 
     * @return Storage id for User Settings
     */
