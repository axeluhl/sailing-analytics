 ...
 * during its construction in {@link UserSettingsBuildingPipelineWithPatching}.
 * The patch may partially or completely modify the resulting settings object in order to provide
 ...
 *
 * @param <S> The type of the settings to patch
 * 
