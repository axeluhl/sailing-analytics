    ...
    public static native CheckoutOption create(String hostedPageJSONString, SuccessCallback onSuccess,
        ...
        return {
            ...
            success : function(hostedPageId) {
                onSuccess.@com.sap.sse.security.ui.client.subscription.chargebee.CheckoutOption.SuccessCallback::call(Ljava/lang/String;)(hostedPageId);
            },
            error : function(error) {
                onError.@com.sap.sse.security.ui.client.subscription.chargebee.CheckoutOption.ErrorCallback::call(Ljava/lang/String;)(error.message ? error.message : error);
            },
            close : function() {
                onClose.@com.sap.sse.security.ui.client.subscription.chargebee.CheckoutOption.CloseCallback::call()();
            }
        };
    }-*/;
