...
public class SecuredBooleanSetting extends AbstractSecuredValueSetting<Boolean> {
    ...
    public SecuredBooleanSetting(String name, AbstractGenericSerializableSettings<SecurityChildSettingsContext> settings,
    ...
    public SecuredBooleanSetting(String name, AbstractGenericSerializableSettings<SecurityChildSettingsContext> settings, Boolean defaultValue,
            PaywallResolver paywallResolver, Action action, SecuredDTO securedDto) {
