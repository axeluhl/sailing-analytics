            ...
            if(statistic.getSettings().isManeuverDirectionEqualWeightingEnabled()) {
                ...
                case PORT:
                    if(portsideManeuvers == null) {
                        try {
                            portsideManeuvers = (ManeuverSpeedDetailsAggregationCreator) aggregationCreatorClass.newInstance();
                ...
                case STARBOARD:
                    if(starboardManeuvers == null) {
                        try {
                            starboardManeuvers = (ManeuverSpeedDetailsAggregationCreator) aggregationCreatorClass.newInstance();
                        } catch (InstantiationException | IllegalAccessException e) {
                        }
                    }
