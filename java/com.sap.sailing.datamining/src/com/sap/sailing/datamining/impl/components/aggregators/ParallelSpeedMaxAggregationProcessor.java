...
public class ParallelSpeedMaxAggregationProcessor extends
    AbstractParallelComparableMaxAggregationProcessor<Speed> {
    
    private static final AggregationProcessorDefinition<Speed, Speed> DEFINITION =
            new SimpleAggregationProcessorDefinition<>(Speed.class, Speed.class, "Maximum", ParallelSpeedMaxAggregationProcessor.class);
    
    public static AggregationProcessorDefinition<Speed, Speed> getDefinition() {
        return DEFINITION;
    }
    
    public ParallelSpeedMaxAggregationProcessor(ExecutorService executor,
