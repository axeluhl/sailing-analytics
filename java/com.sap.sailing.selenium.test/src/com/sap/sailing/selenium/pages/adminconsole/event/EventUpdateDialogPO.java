...
public class EventUpdateDialogPO extends DataEntryDialogPO {
    ...
    public EventUpdateDialogPO(WebDriver driver, WebElement element) {
        super(driver, element);
    }
    
    public VideosTabPO goToVideosTab() {
        return new VideosTabPO(driver, goToTab("Videos", VIDEOS_TAB_ID));
    }
