...
public class AclRevokeAnonymous extends AbstractSeleniumTest {
    ...
    public void test() {
        ...
        List<WebElement> inputs = aclPopup.getInputSuggestionBoxes();
        Assert.assertThat(inputs.get(0).isEnabled(), Matchers.equalTo(true));
        Assert.assertThat(inputs.get(1).isEnabled(), Matchers.equalTo(false));
    }
