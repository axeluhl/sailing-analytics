...
public class SAPFooter extends Composite {
    private static SAPFooterPanelUiBinder uiBinder = GWT.create(SAPFooterPanelUiBinder.class);

    interface SAPFooterPanelUiBinder extends UiBinder<Widget, SAPFooter> {
    }
    ...
    public SAPFooter() {       
        ...
        SAPFooterResources.INSTANCE.css().ensureInjected();
