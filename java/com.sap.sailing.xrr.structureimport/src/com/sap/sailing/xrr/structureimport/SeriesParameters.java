...
public class SeriesParameters {
	...
	public SeriesParameters(boolean firstColumnIsNonDiscardableCarryForward,
	...
	public void setFirstColumnIsNonDiscardableCarryForward(
	...
	public void setHasSplitFleetContiguousScoring(
			boolean hasSplitFleetContiguousScoring) {
		this.hasSplitFleetContiguousScoring = hasSplitFleetContiguousScoring;
	}
