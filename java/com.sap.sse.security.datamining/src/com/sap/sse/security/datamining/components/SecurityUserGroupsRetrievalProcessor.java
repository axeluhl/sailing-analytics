...
public class SecurityUserGroupsRetrievalProcessor extends AbstractRetrievalProcessor<SecurityService, HasUserGroupContext> {
    public SecurityUserGroupsRetrievalProcessor(ExecutorService executor,
