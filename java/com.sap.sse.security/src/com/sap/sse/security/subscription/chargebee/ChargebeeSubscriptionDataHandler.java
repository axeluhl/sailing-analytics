...
public class ChargebeeSubscriptionDataHandler extends AbstractSubscriptionDataHandler {
    ...
    public Subscription toSubscription(SubscriptionData data) {
        return new ChargebeeSubscription(data.getSubscriptionId(), data.getPlanId(), data.getCustomerId(),
                ...
                data.getReocurringPaymentValue(), data.getSubscriptionCreatedAt(), data.getSubscriptionUpdatedAt(),
                data.getSubscriptionActivatedAt(), data.getNextBillingAt(), data.getCurrentTermEnd(),
                data.getCancelledAt(), data.getLatestEventTime(), data.getManualUpdatedAt());
    }
}
