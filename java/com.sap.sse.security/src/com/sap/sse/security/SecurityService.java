...
public interface SecurityService extends ReplicableWithObjectInputStream<ReplicableSecurityService, SecurityOperation<?>> {
     ...
     * {@link #isClientIPAndUserAgentLocked(String, String) locked}, and the locking duration is increased.
     * <p>
     * 
     ...
     * {@link #isClientIPAndUserAgentLocked(String, String) locked} and a successful bearer token-based
    ...
    /**
     * Used in conjunction with {@link #failedBearerTokenAuthentication(String, String)} and
     * {@link #successfulBearerTokenAuthentication(String, String)}. If and only if a locking state for the combination
     * of {@code clientIP} and {@code userAgent} is known and still locked, {@code true} is returned. Unlocking
     * will bappen by calling {@link #successfulBearerTokenAuthentication(String, String)} with an equal combination
     * of {@code clientIP} and {@code userAgent}. Invoking {@link #failedBearerTokenAuthentication(String, String)}
