 ...
 * other way around. The serializers will handle {@link SettingsMap}s and contained {@link SettingsMap} as well as
...
public interface SettingsMap extends Settings {
    /**
     * @return the settings to be processed by serializer implementations.
     */
