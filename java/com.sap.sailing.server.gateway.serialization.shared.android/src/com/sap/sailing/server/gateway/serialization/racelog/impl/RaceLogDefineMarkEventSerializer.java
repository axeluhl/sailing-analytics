...
public class RaceLogDefineMarkEventSerializer extends BaseRaceLogEventSerializer {
    ...
    public static final String VALUE_CLASS = com.sap.sailing.domain.abstractlog.race.tracking.RaceLogDefineMarkEvent.class.getSimpleName();
    ...
    public JSONObject serialize(RaceLogEvent object) {
        com.sap.sailing.domain.abstractlog.race.tracking.RaceLogDefineMarkEvent event = (com.sap.sailing.domain.abstractlog.race.tracking.RaceLogDefineMarkEvent) object;
