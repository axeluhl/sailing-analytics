...
public class MarkJsonDeserializer implements JsonDeserializer<MarkImpl>{
    @Override
    public MarkImpl deserialize(JSONObject object) throws JsonDeserializationException {
        ...
        return new MarkImpl(id, name, type, color, shape, pattern);
    }
}
