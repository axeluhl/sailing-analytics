...
public class RaceLogRegisterBoatEventDeserializer extends BaseRaceLogEventDeserializer {
    private BoatJsonDeserializer boatDeserializer;
    
    public RaceLogRegisterBoatEventDeserializer(JsonDeserializer<Competitor> competitorDeserializer, BoatJsonDeserializer boatDeserializer) {
    ...
    protected RaceLogEvent deserialize(JSONObject object, Serializable id, TimePoint createdAt, AbstractLogEventAuthor author, TimePoint timePoint, int passId, List<Competitor> competitors) throws JsonDeserializationException {
    	...
    	return new RaceLogRegisterBoatEventImpl(createdAt, timePoint, author, id, passId, boat);
    }
