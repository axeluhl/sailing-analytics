...
public class CompetitorWithoutBoatDTOImpl extends NamedDTO implements CompetitorWithoutBoatDTO, Serializable {
    ...
    public CompetitorWithoutBoatDTOImpl() {}
    
    public CompetitorWithoutBoatDTOImpl(String name, String shortName, Color color, String email, String twoLetterIsoCountryCode, String threeLetterIocCountryCode,
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        CompetitorWithoutBoatDTOImpl other = (CompetitorWithoutBoatDTOImpl) obj;
        if (idAsString == null) {
