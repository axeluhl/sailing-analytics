...
public enum BoatClassMasterdata {
    ...
    _5O5 ("5O5", true, 5.03, 1.88, BoatHullType.MONOHULL, "505", "5o5", "505er", "5o5er", "505-er"),
    _12M ("12 Meter", true, 5.97, 1.43, BoatHullType.MONOHULL, "12M", "12mR", "12SQM"),
    _29ER ("29er", true, 4.45, 1.70, BoatHullType.MONOHULL, "29-er"),
    _29ERXX ("29erXX", true, 4.45, 1.77, BoatHullType.MONOHULL, "29XX"),
    _49ER ("49er", true, 4.88, 1.93, BoatHullType.MONOHULL, "49-er"),
    _49ERFX ("49erFX", true, 4.88, 1.93, BoatHullType.MONOHULL, "49FX"),
    _420 ("420", true, 4.20, 1.65, BoatHullType.MONOHULL, "420er", "420M", "420W", "420-er"),
    _470 ("470", true, 4.70, 1.68, BoatHullType.MONOHULL, "470er", "470M", "470W", "470-er"),
    ...
    FINN ("Finn", true, 4.50, 1.51, BoatHullType.MONOHULL),
    FOLKBOAT ("Folkboat", true, 7.68, 2.20, BoatHullType.MONOHULL, "Folke", "Folkeboot"),
    F_16 ("Formula 16", true, 5.00, 2.50, BoatHullType.CATAMARAN, "F16", "F-16"),
    HOBIE_16 ("Hobie 16", true, 5.05, 2.41, BoatHullType.CATAMARAN, "H16"),
    H_BOAT ("H-Boat", true, 8.28, 2.18, BoatHullType.MONOHULL, "HB"),
    HOBIE_TIGER ("Hobie Tiger", true, 5.51, 2.60, BoatHullType.CATAMARAN),
    HOBIE_WILD_CAT ("Hobie Wild Cat", true, 5.49, 2.59, BoatHullType.CATAMARAN, "Hobie Wild Cat F18"),
