...
public enum DetailType implements Serializable, SecuredEnum {
    ...
    LEG_GAP_TO_LEADER_IN_SECONDS_CHANGE(2, ASCENDING, PREMIUM_LEADERBOARD_INFORMATION, "GAP_TO_LEADER_IN_SECONDS_CHANGE"),
    ...
    CHART_WINDWARD_DISTANCE_TO_COMPETITOR_FARTHEST_AHEAD_CHANGE(2, ASCENDING, null),
