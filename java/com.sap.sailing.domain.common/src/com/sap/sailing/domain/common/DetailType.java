...
public enum DetailType implements Serializable {
    ...
    WINDWARD_DISTANCE_TO_GO_IN_METERS(0), AVERAGE_CROSS_TRACK_ERROR_IN_METERS(0), RACE_DISTANCE_TRAVELED(0),
    RACE_AVERAGE_SPEED_OVER_GROUND_IN_KNOTS(2), RACE_GAP_TO_LEADER_IN_SECONDS(0),
    RACE_DISTANCE_TO_LEADER_IN_METERS(0), RACE_AVERAGE_CROSS_TRACK_ERROR_IN_METERS(0),
