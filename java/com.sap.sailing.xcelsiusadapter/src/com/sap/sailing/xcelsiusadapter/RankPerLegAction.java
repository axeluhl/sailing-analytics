            ...
            for (final TrackedLeg trackedLeg : trackedRace.getTrackedLegs()) {
                ...
                for (final Competitor competitor : ranks.keySet()) {
                    if (competitorNameSet == null || competitorNameSet.contains(competitor.getName())) {
                         ...
                         * estimatedTimeToNextMarkInSeconds =
                         * trackedLegOfCompetitor.getEstimatedTimeToNextMarkInSeconds(time);
                         * addColumn(""+(estimatedTimeToNextMarkInSeconds
                         * ==null?"null":estimatedTimeToNextMarkInSeconds)); Speed velocityMadeGood =
                         * trackedLegOfCompetitor.getVelocityMadeGood(time); addColumn(""+(velocityMadeGood==null ?
                         * "null" : velocityMadeGood.getKnots()));
                         */
                    }
                }
