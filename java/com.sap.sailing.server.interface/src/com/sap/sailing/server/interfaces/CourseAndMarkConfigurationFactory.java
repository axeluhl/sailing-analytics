...
public interface CourseAndMarkConfigurationFactory {
     ...
     * {@link MarkProperties#getLastUsedMarkRole()}. If no matching of {@link MarkProperties} using roles is possible, a
     * direct association is done if a {@link MarkProperties} was explicitly mapped to a specific {@link MarkTemplate}
     * before (see {@link MarkProperties#getLastUsedMarkTemplate()}).
     * <p>
     * 
