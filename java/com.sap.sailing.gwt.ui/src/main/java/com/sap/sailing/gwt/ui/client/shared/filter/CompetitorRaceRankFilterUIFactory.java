...
public class CompetitorRaceRankFilterUIFactory extends AbstractCompetitorNumberFilterUIFactory<Integer> { 
    ...
    public CompetitorRaceRankFilterUIFactory(CompetitorRaceRankFilter competitorRaceRankFilter) {
        super(competitorRaceRankFilter, BinaryOperator.Operators.LessThanEquals);
