...
/**
 * Shows a {@link RegattaBoatCertificatesPanel} in a dialog. The panel interacts with a servlet that receives uploaded
...
public class BoatCertificateAssignmentDialog extends DataEntryDialog<Void> {
    ...
    public BoatCertificateAssignmentDialog(final SailingServiceAsync sailingService, UserService userService,
            ...
            DialogCallback<Void> callback, AbstractBoatCertificatesPanel regattaBoatCertificatesPanel) {
        super(stringMessages.actionEditCompetitors(), stringMessages.actionEditCompetitors(), stringMessages.close(),
