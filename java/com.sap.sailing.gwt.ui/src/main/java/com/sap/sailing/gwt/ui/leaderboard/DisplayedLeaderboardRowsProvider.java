...
/**
 * A {@link LeaderboardPanel} does not always display all rows available. One reason for filtering can be a filter set
 ...
 * {@link LeaderboardPanel} interface. Therefore, this interface provides the capabilities needed.
 * 
