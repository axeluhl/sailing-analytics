...
public class LeaderboardGroupConfigPanel extends AbstractRegattaPanel {
    ...
    private void loadGroups() {
        sailingService.getLeaderboardGroups(false /*withGeoLocationData*/, false /*withRaceData*/, new AsyncCallback<List<LeaderboardGroupDTO>>() {
            @Override
    ...
    private void groupSelectionChanged() {
        ...
        if (selectedGroup != null) {
            sailingService.getLeaderboardGroupByName(selectedGroup.name, false /*withGeoLocationData*/, false /*withRaceData*/, new AsyncCallback<LeaderboardGroupDTO>() {
                @Override
                public void onFailure(Throwable t) {
