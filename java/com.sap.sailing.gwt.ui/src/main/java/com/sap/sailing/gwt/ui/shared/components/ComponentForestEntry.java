...
public interface ComponentForestEntry {
    ...
    /**
     * A component forest entry may or may not have a {@link Widget} used to render its contents. Typically,
     * entries with sub-entries don't affort a widget of their own but let the framework choose a container
