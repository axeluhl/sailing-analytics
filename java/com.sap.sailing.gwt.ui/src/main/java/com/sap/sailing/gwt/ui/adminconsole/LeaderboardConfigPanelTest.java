...
public class LeaderboardConfigPanelTest extends FormPanel implements SelectedLeaderboardProvider, RegattaDisplayer, RaceSelectionChangeListener,
    ...
    public LeaderboardConfigPanelTest(SailingServiceAsync sailingService, AdminConsoleEntryPoint adminConsole,
    ...
    public void loadLeaderboards() {
        sailingService.getLeaderboards(new AsyncCallback<List<StrippedLeaderboardDTO>>() {
            ...
            public void onFailure(Throwable t) {
                LeaderboardConfigPanelTest.this.errorReporter.reportError("Error trying to obtain list of leaderboards: "
                        + t.getMessage());
            }
        });
    }
    ...
    public void loadAndRefreshLeaderboard(final String leaderboardName, final String nameOfRaceColumnToSelect) {
        sailingService.getLeaderboard(leaderboardName, new AsyncCallback<StrippedLeaderboardDTO>() {
            ...
            @Override
            public void onFailure(Throwable t) {
                LeaderboardConfigPanelTest.this.errorReporter.reportError("Error trying to update leaderboard with name " +  leaderboardName +" : "
                        + t.getMessage());
            }
        });
    }
    ...
    private void leaderboardSelectionChanged() {
        ...
        Scheduler.get().scheduleFinally(new ScheduledCommand() {
            @Override
            public void execute() {
                raceSelectionProvider.addRaceSelectionChangeListener(LeaderboardConfigPanelTest.this);
            }
        });
