...
public interface SailingServiceAsync {
     ...
     * 
     * @param regattaAndRaceidentifier
    ...
    /**
     * @param from
     *            if <code>null</code>, the tracked race's start of tracking is used
     * @param to
     *            if <code>null</code>, the tracked race's time point of newest event is used
     */
    ...
    /**
     * Same as
     * {@link #getWindInfo(RegattaAndRaceIdentifier, Date, long, int, double, double, Collection, AsyncCallback)}, only
     ...
     */
    void getBoatPositions(RegattaAndRaceIdentifier raceIdentifier, Map<CompetitorDTO, Date> from,
     ...
     *            list will contain one entry per leg of the race {@link com.sap.sailing.domain.base.Course} for those
     *            race columns whose {@link com.sap.sailing.domain.base.RaceColumn#getType() name} is contained in
    ...
    void createFlexibleLeaderboard(String leaderboardName, int[] discardThresholds,
            ScoringSchemeType scoringSchemeType, AsyncCallback<StrippedLeaderboardDTO> asyncCallback);
    ...
    void getDouglasPoints(RegattaAndRaceIdentifier raceIdentifier, Map<CompetitorDTO, Date> from,
            Map<CompetitorDTO, Date> to, double meters, AsyncCallback<Map<CompetitorDTO, List<GPSFixDTO>>> callback);
     ...
     *            TODO
     */
    void createLeaderboardGroup(String groupName, String description, boolean displayGroupsInReverseOrder,
     ...
     *            The list of names of the new leaderboards of the group
     */
    ...
    /**
     * Creates a {@link EventDTO} for the {@link com.sap.sailing.domain.base.Event} with the name <code>eventName</code>
     * , which contains the name, the description and a list with {@link RegattaDTO RegattaDTOs} contained in the event.<br />
    ...
    void createEvent(String eventName, String description, String publicationUrl, boolean isPublic,
    ...
    void getRaceCourseMarks(RegattaAndRaceIdentifier raceIdentifier, Date date,
            AsyncCallback<RaceCourseMarksDTO> callback);
