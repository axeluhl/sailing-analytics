...
public interface HomeResources extends ClientBundle {
    ...
    public interface MinWidth25emCss extends MainCss {
    }

    @Source("com/sap/sailing/gwt/home/small.css")
    MinWidth25emCss smallCss();

    public interface MinWidth50emCss extends MainCss {
    }

    @Source("com/sap/sailing/gwt/home/medium.css")
    MinWidth50emCss mediumCss();
