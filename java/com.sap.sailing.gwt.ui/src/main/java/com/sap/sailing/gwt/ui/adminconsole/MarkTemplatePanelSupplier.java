...
public class MarkTemplatePanelSupplier extends AdminConsolePanelSupplier<MarkTemplatePanel> {

    private final StringMessages stringMessages;
    private final Presenter presenter;

    public MarkTemplatePanelSupplier(final StringMessages stringMessages, final Presenter presenter) {
        super();
