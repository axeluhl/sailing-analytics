...
public class OtherContent extends Widget implements RefreshableWidget<OtherDTO> {
    ...
    interface ExampleContentUiBinder extends UiBinder<Element, OtherContent> {
    }
    ...
    @Override
    public void setData(OtherDTO data, long nextUpdate, int updateNo) {
