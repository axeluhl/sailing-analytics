 ...
 * 
 * @author Frank
 * A color provider for a competitor.
 * A color of a competitor can either be the same for all races of a regatta or it can be race specific.
 * Race specific can make sense e.g. when a competitor is changing it's boat during a regatta. 
 */
