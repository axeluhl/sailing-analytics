...
public class ClassicInitialImpl extends ResizeComposite implements ClassicInitialView {
    private static SlideInitViewImplUiBinder uiBinder = GWT.create(SlideInitViewImplUiBinder.class);

    interface SlideInitViewImplUiBinder extends UiBinder<Widget, ClassicInitialImpl> {
    }
