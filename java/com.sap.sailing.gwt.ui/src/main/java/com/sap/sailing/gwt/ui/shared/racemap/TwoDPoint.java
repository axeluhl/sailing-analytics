...
public class TwoDPoint {
    ...
    // A //B //C //B'
    public static boolean isOnTheInside(TwoDPoint beforePoint, TwoDPoint origin, TwoDPoint afterPoint,
            TwoDPoint newOrigin) {
    ...
    // A //B //C //Bfirst
    public static TwoDSegment getBeforeNew(TwoDPoint beforePoint, TwoDPoint origin, TwoDPoint afterPoint,
            TwoDPoint newOrigin) {
        TwoDSegment AB = new TwoDSegment(beforePoint, origin);
