...
public class WindPanel extends FormPanel implements RegattasDisplayer {
    ...
    public WindPanel(final SailingWriteServiceAsync sailingWriteService, final UserService userService,
        ...
        this.windSourcesToExcludeSelectorPanel = new WindSourcesToExcludeSelectorPanel(sailingWriteService, stringMessages,
                errorReporter);
        ...
        addWindFixButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if (selectedRace != null) {
                    ...
                    sailingWriteService.getCoursePositions(selectedRace, race.trackedRace.startOfTracking, new AsyncCallback<CoursePositionsDTO>() {
                        @Override
        ...
        actionsColumn.addAction(DefaultActionsImagesBarCell.ACTION_DELETE, UPDATE, wind -> {
            ...
            final RegattaAndRaceIdentifier raceIdentifier = selectedRaces.get(selectedRaces.size() - 1)
                    .getRaceIdentifier();
            sailingWriteService.removeWind(raceIdentifier, wind, new AsyncCallback<Void>() {
                @Override
        ...
        importButton.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if (Window.confirm(warningMessage)) {
                    ...
                    sailingWriteService.importWindFromIgtimi(new ArrayList<>(refreshableRaceSelectionModel.getSelectedSet()),
    ...
    private Pair<CaptionPanel, ExpeditionAllInOneImportPanel> createExpeditionAllInOneImportPanel(RegattaRefresher regattaRefresher) {
        ...
        final ExpeditionAllInOneImportPanel expeditionAllInOneImportPanel = new ExpeditionAllInOneImportPanel(stringMessages, sailingWriteService, userService, errorReporter, regattaRefresher);
    ...
    private void addWindFix(final WindDTO wind, final RaceDTO race) {
        ...
        sailingWriteService.setWind(raceIdentifier, wind, new AsyncCallback<Void>() {
            @Override
            public void onSuccess(Void result) {
    ...
    public void showWind(final RegattaAndRaceIdentifier raceIdentifier, final RaceDTO race) {
        sailingWriteService.getWindSourcesInfo(raceIdentifier, new AsyncCallback<WindInfoForRaceDTO>() {
            @Override
            public void onSuccess(final WindInfoForRaceDTO result) {
                if (result != null) {
                    ...
                    sailingWriteService.getRawWindFixes(raceIdentifier, null, new AsyncCallback<WindInfoForRaceDTO>() {
                        @Override
    ...
    private void setRaceIsKnownToStartUpwind() {
        ...
        sailingWriteService.setRaceIsKnownToStartUpwind(selectedRace, raceIsKnownToStartUpwindBox.getValue(), new AsyncCallback<Void>() {
            @Override
            public void onFailure(Throwable caught) {
    ...
    private void showWindFixesList(final RegattaAndRaceIdentifier raceIdentifier, final RaceDTO race) {
        ...
        if (race.startOfRace != null) {
            sailingWriteService.getAveragedWindInfo(raceIdentifier, race.startOfRace, 30000L, 100, windSourceTypeNames,
