 ...
 */
public final class HeadlessSuggestedMultiSelection<T> extends Composite
        implements SuggestedMultiSelectionView<T> {

    private static HeadlessSuggestedMultiSelectionUiBinder uiBinder = GWT.create(HeadlessSuggestedMultiSelectionUiBinder.class);

    interface HeadlessSuggestedMultiSelectionUiBinder extends UiBinder<Widget, HeadlessSuggestedMultiSelection<?>> {
    }
    ...
    private HeadlessSuggestedMultiSelection(SuggestedMultiSelectionPresenter<T, ?> presenter,
        ...
        this.suggestionWidgetUi = widgetProvider.getSuggestBoxFilter(selectedItem -> {
            ...
            HeadlessSuggestedMultiSelection.this.addSelectedItem(selectedItem);
        });
    ...
    public static HeadlessSuggestedMultiSelection<SimpleCompetitorWithIdDTO> forCompetitors(
            final SuggestedMultiSelectionPresenter<SimpleCompetitorWithIdDTO, ?> presenter, String headerTitle,
            FlagImageResolver flagImageResolver) {
        return new HeadlessSuggestedMultiSelection<>(presenter, new WidgetProvider<SimpleCompetitorWithIdDTO>() {
            @Override
    ...
    public static HeadlessSuggestedMultiSelection<BoatClassDTO> forBoatClasses(
            final SuggestedMultiSelectionPresenter<BoatClassDTO, ?> presenter, String headerTitle) {
        return new HeadlessSuggestedMultiSelection<>(presenter, new WidgetProvider<BoatClassDTO>() {
            @Override
