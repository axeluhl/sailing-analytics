...
//					System.out.println("\r\nXXX: Is on the inside: " + isOnTheInside);
					...
					TwoDPoint head1 = TwoDPoint.getDistancedPoint(origin, distance, convertToTwoDPoint(points[indexOfMovedPoint - 1]));
					TwoDPoint head2 = TwoDPoint.getDistancedPoint(origin, distance, convertToTwoDPoint(points[indexOfMovedPoint + 1]));						
					TwoDPoint newOrigin = TwoDPoint.getCorrectProjection(origin, head1, head2, convertToTwoDPoint(polyline.getVertex(indexOfMovedPoint)));
					...
					{
						TwoDSegment afterLine = new TwoDSegment(convertToTwoDPoint(points[indexOfMovedPoint + 1]), convertToTwoDPoint(points[indexOfMovedPoint + 2]));
						TwoDVector afterVector = new TwoDVector(origin, convertToTwoDPoint(points[indexOfMovedPoint + 1]));
					...
					{
						TwoDSegment beforeLine = new TwoDSegment(convertToTwoDPoint(points[indexOfMovedPoint - 2]), convertToTwoDPoint(points[indexOfMovedPoint - 1]));
						TwoDVector beforeVector = new TwoDVector(convertToTwoDPoint(points[indexOfMovedPoint - 1]), origin);
						TwoDPoint beforeNewOrigin = TwoDPoint.projectToLineByVector(newOrigin, beforeLine, beforeVector);
