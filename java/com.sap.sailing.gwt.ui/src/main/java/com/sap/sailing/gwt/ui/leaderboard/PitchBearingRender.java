...
public class PitchBearingRender extends MinMaxRenderer {

    private double maxAbsDoubleValue = 0.5d;

    public PitchBearingRender(HasStringAndDoubleValue valueProvider, Comparator<LeaderboardRowDTO> comparator) {
