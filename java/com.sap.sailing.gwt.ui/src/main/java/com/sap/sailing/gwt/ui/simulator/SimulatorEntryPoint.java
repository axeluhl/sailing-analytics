...
public class SimulatorEntryPoint implements EntryPoint {
    ...
    private WindFieldCanvasOverlay windField;
    private WindLatticeCanvasOverlay windLattice;
    ...
    private void buildUi() {
        ...
        //windField = new WindFieldCanvasOverlay();
        //mapw.addOverlay(windField);
        
        windLattice = new WindLatticeCanvasOverlay();
        mapw.addOverlay(windLattice);
        
        // Add the map to the HTML host page
        RootLayoutPanel.get().add(panel);
        
        if (locations != null && locations.size() > 0) {
            selectRaceLocation(locations.get(0));
        }
    }
    ...
    private void initMap() {
        ...
        mapw.addMapClickHandler(new MapClickHandler() {
            ...
            public void onClick(MapClickEvent event) {
                ...
                //windField.setPosition(currentPoint);
                //windField.redraw(true);
            }
        });
    }
    ...
    private void generateWindLattice(LatLng center) {
        ...
        simulatorSvc.getWindLatice(params, new AsyncCallback<WindLatticeDTO>() {
            ...
            public void onSuccess(WindLatticeDTO wl) {
                windLattice.setPosition(currentPoint);
                windLattice.setWindLattice(wl);
                windLattice.redraw(true);
