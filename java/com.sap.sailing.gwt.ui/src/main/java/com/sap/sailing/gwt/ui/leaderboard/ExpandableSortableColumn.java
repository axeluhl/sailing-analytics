...
public abstract class ExpandableSortableColumn<C> extends LeaderboardSortableColumnWithMinMax<LeaderboardRowDTO, C> {
    ...
    private final UnStyledLeaderboardPanel leaderboardPanel;
    ...
    public ExpandableSortableColumn(UnStyledLeaderboardPanel leaderboardPanel, boolean enableExpansion, Cell<C> cell,
    ...
    protected UnStyledLeaderboardPanel getLeaderboardPanel() {
