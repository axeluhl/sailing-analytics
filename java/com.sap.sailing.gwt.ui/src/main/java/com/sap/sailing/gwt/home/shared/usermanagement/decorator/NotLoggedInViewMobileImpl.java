...
public class NotLoggedInViewMobileImpl extends Composite implements NotLoggedInView {

    private static NotLoggedInViewUiBinder uiBinder = GWT.create(NotLoggedInViewUiBinder.class);

    interface NotLoggedInViewUiBinder extends UiBinder<Widget, NotLoggedInViewMobileImpl> {
    }
    ...
    public NotLoggedInViewMobileImpl() {
