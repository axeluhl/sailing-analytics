...
public class EventPrefixes {

    public static final String EventDefault = "/event/";
    public static final String MultiregattaOverview = "/multiregatta/overview/";
    public static final String MultiregattaRegattas = "/multiregatta/regattas/";
    public static final String MultiregattaMedia = "/multiregatta/media/";
    ...
    public static final String SeriesOverview = "/series/overview/";
