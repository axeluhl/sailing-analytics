 ...
 * may be changed in future once more information is available.
 * 
 * @author Simon Marcel Pamies
 */
public class GC32VectorGraphics extends BoatClassVectorGraphics {
    
    public GC32VectorGraphics(BoatClassMasterdata... compatibleBoatClasses) {
