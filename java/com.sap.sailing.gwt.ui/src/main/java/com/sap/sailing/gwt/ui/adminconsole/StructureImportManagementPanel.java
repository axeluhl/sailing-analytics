...
public class StructureImportManagementPanel extends SimplePanel implements RegattaStructureProvider {
    ...
    private final EventsRefresherAndProvider eventManagementPanel;
    ...
    public StructureImportManagementPanel(SailingServiceWriteAsync sailingServiceWrite, UserService userService,
            ...
            EventsRefresherAndProvider eventManagementPanel) {
    ...
    private Widget createEventSelectionAndCreateEventButtonUI() {
        ...
        Util.addAll(eventManagementPanel.getAllEvents(), existingEvents);
