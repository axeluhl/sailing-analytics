...
public class AsyncSelectionTablesPanel implements SelectionProvider {
    ...
    public AsyncSelectionTablesPanel(StringMessages stringMessages, SailingServiceAsync sailingService,
