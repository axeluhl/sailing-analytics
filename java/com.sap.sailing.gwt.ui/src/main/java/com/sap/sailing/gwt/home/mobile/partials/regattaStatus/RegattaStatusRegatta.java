...
public class RegattaStatusRegatta extends Composite {
    ...
    public RegattaStatusRegatta(RegattaMetadataDTO regatta) {
        initWidget(uiBinder.createAndBindUi(this));
        initRegattaHeader(regatta);
    }
    ...
    private void initRegattaHeader(RegattaMetadataDTO regatta) {
