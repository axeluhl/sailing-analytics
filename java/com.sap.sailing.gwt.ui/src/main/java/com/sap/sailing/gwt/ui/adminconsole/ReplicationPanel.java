...
public class ReplicationPanel extends FlowPanel {
    ...
    private void addReplication() {
        AddReplicationDialog dialog = new AddReplicationDialog(null,
                new DialogCallback<UtilNew.Triple<UtilNew.Triple<String, String, String>, Integer, Integer>>() {
                    @Override
                    public void ok(final UtilNew.Triple<UtilNew.Triple<String, String, String>, Integer, Integer> masterNameAndExchangeNameAndMessagingPortNumberAndServletPortNumber) {
     ...
     *
     */
    private class AddReplicationDialog extends DataEntryDialog<UtilNew.Triple<UtilNew.Triple<String, String, String>, Integer, Integer>> {
        ...
        public AddReplicationDialog(final Validator<UtilNew.Triple<UtilNew.Triple<String, String, String>, Integer, Integer>> validator,
                final DialogCallback<UtilNew.Triple<UtilNew.Triple<String, String, String>, Integer, Integer>> callback) {
        ...
        @Override
        protected UtilNew.Triple<UtilNew.Triple<String, String, String>, Integer, Integer> getResult() {
            return new UtilNew.Triple<UtilNew.Triple<String, String, String>, Integer, Integer>(
                    new UtilNew.Triple<String, String, String>(exchangeHostnameEntryField.getText(), hostnameEntryField.getText(), exchangenameEntryField.getText()),
