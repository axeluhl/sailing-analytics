...
public class GetLeaderboardDataEntriesAction implements AsyncAction<List<UtilNew.Triple<String, List<CompetitorDTO>, List<Double>>>> {
    ...
    @Override
    public void execute(AsyncCallback<List<UtilNew.Triple<String, List<CompetitorDTO>, List<Double>>>> callback) {
