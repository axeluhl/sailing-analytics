...
import com.sap.sailing.gwt.ui.adminconsole.mobile.app.places.events.MobileEventsActivity;
...
public class AdminConsoleMobileActivityMapper implements ActivityMapper {
    ...
    public Activity getActivity(Place place) {
        ...
        if (place instanceof MobileEventsPlace) {
            return new MobileEventsActivity((MobileEventsPlace) place, clientFactory);
        }
        return null;
    }
}
