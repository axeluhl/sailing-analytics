...
public class RaceMapSettings extends AbstractGenericSerializableSettingsWithContext<SecurityChildSettingsContext> {
    ...
    protected void addChildSettings(SecurityChildSettingsContext context) {
        ...
        showWindStreamletOverlaySetting = new SecuredBooleanSetting(PARAM_VIEW_SHOW_STREAMLETS, this, false, context.getPaywallResolver(), TrackedRaceActions.VIEWSTREAMLETS, context.getSecuredDTO());
        showWindStreamletColorsSetting = new SecuredBooleanSetting(PARAM_VIEW_SHOW_STREAMLET_COLORS, this, false, context.getPaywallResolver(), TrackedRaceActions.VIEWSTREAMLETS, context.getSecuredDTO());
        showSimulationOverlaySetting = new SecuredBooleanSetting(PARAM_VIEW_SHOW_SIMULATION, this, false, context.getPaywallResolver(), TrackedRaceActions.SIMULATOR, context.getSecuredDTO());
