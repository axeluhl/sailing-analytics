...
public class RegattaStatusRace extends Composite {
    ...
    public RegattaStatusRace(LiveRaceDTO race) {
        ...
        linkUi.setTitle(race.getRaceName());
    ...
    private void initRaceFlagInfo(FlagStateDTO value) {
        raceFlagContainerUi.setInnerSafeHtml(SailingFlagsBuilder.render(value, 0.55, FlagsMeaningExplanator.getFlagsMeaning(I18N,
