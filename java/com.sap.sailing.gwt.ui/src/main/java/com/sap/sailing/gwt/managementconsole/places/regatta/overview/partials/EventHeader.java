...
public class EventHeader extends Composite implements View<RegattaOverviewView.Presenter> {
    ...
    public void setRegattaSectionSelected(final boolean selected) {
        regattaSection.setStyleName(local_res.style().menuSelected(), selected);
    }
