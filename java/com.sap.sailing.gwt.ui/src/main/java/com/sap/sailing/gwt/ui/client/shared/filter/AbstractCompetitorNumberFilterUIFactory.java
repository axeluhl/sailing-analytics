...
public abstract class AbstractCompetitorNumberFilterUIFactory<T extends Number> implements FilterUIFactory<CompetitorWithBoatDTO> {
    protected List<BinaryOperator.Operators> supportedOperators;
    protected BinaryOperator.Operators defaultOperator;
    protected NumberFilter<CompetitorWithBoatDTO, T> competitorNumberFilter;

    public AbstractCompetitorNumberFilterUIFactory(NumberFilter<CompetitorWithBoatDTO, T> competitorNumberFilter, BinaryOperator.Operators defaultOperator) {
