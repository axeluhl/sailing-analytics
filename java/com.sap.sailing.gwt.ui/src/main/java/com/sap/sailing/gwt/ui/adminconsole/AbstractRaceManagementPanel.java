...
public abstract class AbstractRaceManagementPanel extends AbstractEventManagementPanel {
    ...
    public AbstractRaceManagementPanel(final SailingWriteServiceAsync sailingService, ErrorReporter errorReporter,
    ...
    public AbstractRaceManagementPanel(final SailingWriteServiceAsync sailingService,
