...
public interface GroupingProvider
    ...
    /**
     * Sets the i-th dimension to group by to the function specified by {@code dimensionToGroupBy}.
     * If {@code i} matches the last grouping dimension drop-down, its value is set and another dimension
     * drop-down is created if there are dimensions left to select for grouping. Otherwise, the selected
     * drop-down's value is set to the function identified by {@code dimensionToGroupBy}.
     */
