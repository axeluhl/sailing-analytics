...
public class DeviceConfigurationPanelSupplier extends AdminConsolePanelSupplier<DeviceConfigurationPanel> {
    ...
    public DeviceConfigurationPanelSupplier(final StringMessages stringMessages, final Presenter presenter) {
        super();
    ...
    public DeviceConfigurationPanel init() {
        ...
        final DeviceConfigurationPanel deviceConfigurationUserPanel = new DeviceConfigurationPanel(presenter,
                stringMessages);
