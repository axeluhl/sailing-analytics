...
public class MiniLeaderboardActivityProxy extends AbstractActivityProxy {
    ...
    private final MiniLeaderboardPlace currentPlace;

    public MiniLeaderboardActivityProxy(MiniLeaderboardPlace place, MobileApplicationClientFactory clientFactory) {
