...
public class MarkRolePanelSupplier extends AdminConsolePanelSupplier<MarkRolePanel> {

    private final StringMessages stringMessages;
    private final Presenter presenter;

    public MarkRolePanelSupplier(final StringMessages stringMessages, final Presenter presenter) {
        super();
