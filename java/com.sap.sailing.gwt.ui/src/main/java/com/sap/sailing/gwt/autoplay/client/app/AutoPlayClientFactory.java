...
import com.sap.sailing.gwt.home.desktop.places.user.profile.WithSailingWriteService;
import com.sap.sailing.gwt.ui.client.SailingClientFactory;

public interface AutoPlayClientFactory extends SailingClientFactory, WithSailingWriteService {
