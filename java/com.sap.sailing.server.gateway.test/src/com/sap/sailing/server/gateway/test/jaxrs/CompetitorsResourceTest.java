...
public class CompetitorsResourceTest extends AbstractJaxRsApiTest {
    ...
    public void setUp() {
        ...
        racingEventService.getBaseDomainFactory().getOrCreateCompetitor(id, name, null, null, null, team, boat, /* timeOnTimeFactor */ null, /* timeOnDistanceAllowancePerNauticalMile */ null);
    }
