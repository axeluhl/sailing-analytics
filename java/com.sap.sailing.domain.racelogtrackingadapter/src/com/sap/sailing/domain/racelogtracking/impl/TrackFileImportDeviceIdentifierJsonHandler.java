...
public class TrackFileImportDeviceIdentifierJsonHandler implements DeviceIdentifierJsonHandler {
    ...
    @Override
    public UtilNew.Pair<String, JSONObject> serialize(DeviceIdentifier deviceIdentifier) throws TransformationException {
        ...
        return new UtilNew.Pair<String ,JSONObject>(TrackFileImportDeviceIdentifier.TYPE, result);
    }
