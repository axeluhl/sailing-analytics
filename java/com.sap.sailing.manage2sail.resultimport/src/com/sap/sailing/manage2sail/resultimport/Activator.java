...
public class Activator implements BundleActivator {
    private static String MANAGE2SAIL_URL = "https://orm.manage2sail.com/shadowtest_info/api/public/links/event/58f73e6c-ec07-4655-972c-e5d730f0048e?accesstoken=bDAv8CwsTM94ujZ&mediaType=json";
    ...
    public void start(BundleContext bundleContext) throws Exception {
        ...
        ResultUrlRegistry.INSTANCE.registerResultUrl(ScoreCorrectionProviderImpl.NAME, new URL(MANAGE2SAIL_URL));
