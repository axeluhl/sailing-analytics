package com.sap.sailing.domain.smartphoneadapter.test.manual;
...
import com.sap.sailing.domain.smartphoneadapter.test.JsonOverHttpTest;
...
public class PostFixes extends JsonOverHttpTest {
    ...
    private void recordFix(GPSFixMoving... fix) throws IOException {
        ...
        executeRequest("POST", getUrl(URL_SS + "/recordFixes"), request);
    }
