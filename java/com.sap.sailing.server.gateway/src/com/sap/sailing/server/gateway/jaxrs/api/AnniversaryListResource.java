...
public class AnniversaryListResource extends AbstractSailingServerResource {
    ...
    private final SimpleAnniversaryRaceInfoJsonSerializer anniversaryRaceListJsonSerializer = new SimpleAnniversaryRaceInfoJsonSerializer();
                    ...
                    for (RaceColumn race : leaderboard.getRaceColumns()) {
                        for (Fleet fleet : race.getFleets()) {
                            ...
                            if (trackedRace != null) {
                                ...
                                SimpleAnniversaryRaceInfo raceInfo = new SimpleAnniversaryRaceInfo(raceIdentifier,trackedRace.getStartOfRace().asDate());
