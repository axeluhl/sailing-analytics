...
public class CompetitorsAndBoatsJsonExportServlet extends AbstractJsonHttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        for (Competitor competitor : leaderboard.getCompetitors(raceColumn, fleet)) {
            ...
            if (getSecurityService().hasCurrentUserOneOfExplicitPermissions(competitor, PublicReadableActions.READ_AND_READ_PUBLIC_ACTIONS) &&
                    getSecurityService().hasCurrentUserOneOfExplicitPermissions(boat, PublicReadableActions.READ_AND_READ_PUBLIC_ACTIONS)) {
