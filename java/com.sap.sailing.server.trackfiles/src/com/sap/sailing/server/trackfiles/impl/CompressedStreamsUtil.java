...
public final class CompressedStreamsUtil {
    ...
    public interface FileHandler {
        void handle(String fileName, InputStream inputStream, Charset charset) throws IOException, FormatNotSupportedException;
    }
    ...
    public static void handlePotentiallyCompressedFiles(final String filename, final InputStream inputStream,
            Charset charset, FileHandler fileHandler) throws IOException, FormatNotSupportedException {
