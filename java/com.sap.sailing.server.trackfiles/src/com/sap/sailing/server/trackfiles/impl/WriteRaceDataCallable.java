...
class WriteRaceDataCallable implements Callable<Void> {
	...
	public WriteRaceDataCallable(TrackedRace race,
			TrackFilesDataSource data, TrackFilesFormat format,
	...
	public Void call() throws Exception {
		...
		ZipEntry entry = new ZipEntry(race.getRaceIdentifier()
				.getRegattaName()
				+ "/"
				+ race.getRaceIdentifier().getRaceName()
				+ " - "
