...
public class CompetitorSelectionPopup extends Composite implements HasWidgets, CompetitorTableRowSelectionListener {
    ...
    private CompetitorWithoutBoatDTO currentCompetitorSelected;
    ...
    public void show(List<CompetitorWithoutBoatDTO> competitorList) {
    ...
    public void notifyListenerAboutOKButtonClickedWithSelectedCompetitorName(CompetitorWithoutBoatDTO competitor) {
