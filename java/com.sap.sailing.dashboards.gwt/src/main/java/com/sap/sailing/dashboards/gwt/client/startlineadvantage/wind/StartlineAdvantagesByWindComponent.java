package com.sap.sailing.dashboards.gwt.client.startlineadvantage.wind;
...
import com.sap.sailing.dashboards.gwt.client.startlineadvantage.wind.chart.StartlineAdvantagesOnLineChart;
...
public class StartlineAdvantagesByWindComponent extends Composite implements HasWidgets, PollsLiveDataEvery5Seconds {
    ...
    public StartlineAdvantagesByWindComponent(DashboardClientFactory dashboardClientFactory) {
        StartlineAdvantagesByWindComponentResources.INSTANCE.gss().ensureInjected();
