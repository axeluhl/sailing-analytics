...
public class SettingsButtonWithSelectionIndicationLabel extends Composite {
    ...
    private static SettingsButtonWithSelectionIndicationLabelUiBinder uiBinder = GWT.create(SettingsButtonWithSelectionIndicationLabelUiBinder.class);
    interface SettingsButtonWithSelectionIndicationLabelUiBinder extends UiBinder<Widget, SettingsButtonWithSelectionIndicationLabel> {}
    ...
    public void addClickHanderToSettingsButton(ClickHandler clickHandler){
        settingsButton.addDomHandler(clickHandler, ClickEvent.getType());
    }
