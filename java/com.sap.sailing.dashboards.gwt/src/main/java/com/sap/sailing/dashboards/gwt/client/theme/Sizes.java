...
public class Sizes {
    ...
    public static final String DASHBOARD_FONT_SIZE_LARGE = "18px";
    public static final String DASHBOARD_FONT_SIZE_VERY_LARGE = "25px";
    
    public static final String DASHBOARD_SPACE_VERY_SMALL = "10px";
    public static final String DASHBOARD_SPACE_SMALL = "30px";
    public static final String DASHBOARD_SPACE_MEDIUM = "40px";
