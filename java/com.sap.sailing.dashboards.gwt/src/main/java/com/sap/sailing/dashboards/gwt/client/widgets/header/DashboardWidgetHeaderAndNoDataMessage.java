...
public class DashboardWidgetHeaderAndNoDataMessage extends Composite implements HasWidgets {
    ...
    interface DashboardWidgetHeaderAndNoDataMessageUiBinder extends UiBinder<Widget, DashboardWidgetHeaderAndNoDataMessage> {
    }
    ...
    public void showNoDataMessageWithHeaderAndMessage(String header, String message) {
    ...
    public void adaptSizeOfNoDataMessageDiv() {
//        Scheduler.get().scheduleDeferred(new Command() {
//            public void execute () {
              double widthOfNoDataMessageHeader = Double.parseDouble(noDataMessageHeader.getStyle().getWidth());
              Window.alert("asdfasdfasfd");
              Window.alert("widthOfNoDataMessageHeader "+widthOfNoDataMessageHeader);
              noDataMessage.getStyle().setWidth(widthOfNoDataMessageHeader, Unit.PX);
//            }
//          });
    }
