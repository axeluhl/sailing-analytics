...
public class PositioningJsonDeserializer implements JsonDeserializer<Positioning> {
    ...
    public Positioning deserialize(JSONObject object) throws JsonDeserializationException {
        ...
        } else if (object.containsKey(PositioningJsonSerializer.FIELD_POSITION)) {
            result = new TrackingDeviceBasedPositioningImpl(
                    deviceIdentifierDeserializer.deserialize((JSONObject) object.get(PositioningJsonSerializer.FIELD_POSITION)));
        } else {
