...
public class CommonMarkPropertiesWithTagsJsonDeserializer
        implements JsonDeserializer<CommonMarkPropertiesWithTags> {
    ...
    @Override
    public CommonMarkPropertiesWithTags deserialize(JSONObject json) throws JsonDeserializationException {
        ...
        return new CommonMarkPropertiesWithTagsImpl(commonMarkProperties, tags);
    }
}
