...
public class TeamJsonDeserializer implements JsonDeserializer<Team> {
    ...
    @Override
    public Team deserialize(JSONObject object) throws JsonDeserializationException {
        String name = (String) object.get(TeamJsonSerializer.FIELD_NAME);
        Person coach = personDeserializer.deserialize((JSONObject) object.get(TeamJsonSerializer.FIELD_COACH));
