...
public class TestColumnSwapping {
    ...
    public void prepareColumnSwapping() {
        ...
        try {
            ...
            leaderboardOriginalDTO.addRace("Race1", /* explicitFactor */ null, raceColumn.getFactor(), DEFAULT_FLEET, true, null, null);
            leaderboardOriginalDTO.addRace("Race3", /* explicitFactor */ null, raceColumn.getFactor(), DEFAULT_FLEET, true, null, null);
            leaderboardOriginalDTO.addRace("Race2", /* explicitFactor */ null, raceColumn.getFactor(), DEFAULT_FLEET, true, null, null);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public void testLeaderBoardDTOMethods() {
        ...
        lb.addRace("1", /* explicitFactor */ null, raceColumn.getFactor(), DEFAULT_FLEET, false, null, null);
        lb.addRace("2", /* explicitFactor */ null, raceColumn.getFactor(), DEFAULT_FLEET, false, null, null);
        lb.addRace("3", /* explicitFactor */ null, raceColumn.getFactor(), DEFAULT_FLEET, true, null, null);
        lb.moveRaceDown("1");
