...
public class TestColumnSwapping {
    ...
    public void prepareColumnSwapping() {
        ...
        service.createFlexibleLeaderboard(LEADERBOARDNAME, null, disc, ScoringSchemeType.LOW_POINT);
    ...
    public void testSailingService() {
        ...
        int td[] = { 5, 8 };
        sailingService.createFlexibleLeaderboard(TEST_LEADERBOARD_NAME, null, td, ScoringSchemeType.LOW_POINT);
