...
/**
 * GSVEvent contains the satellite information collected by
 * {@link net.sf.marineapi.provider.GSVProvider}.
 * 
 * @author Kimmo Tuukkanen
 * @version $Revision$
 */
public class GSVEvent extends ProviderEvent {
     ...
     * @param source
     */
    public GSVEvent(Object source, GSASentence gsa, List<SatelliteInfo> info) {
        super(source);
        this.gsa = gsa;
        this.info = info;
    }
