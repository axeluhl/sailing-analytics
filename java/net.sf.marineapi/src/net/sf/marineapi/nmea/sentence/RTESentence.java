...
public interface RTESentence extends Sentence {
     ...
     * @throws net.sf.marineapi.parser.DataNotAvailableException If the sentence index or sentence count
     *             is not available.
     * @throws net.sf.marineapi.parser.ParseException If sentence index or count fields contain
     ...
     * @throws net.sf.marineapi.parser.DataNotAvailableException If the data is not available.
     * @throws net.sf.marineapi.parser.ParseException If status field contains illegal value.
     */
