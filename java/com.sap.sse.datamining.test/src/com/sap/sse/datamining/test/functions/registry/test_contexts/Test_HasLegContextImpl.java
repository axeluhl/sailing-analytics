...
public class Test_HasLegContextImpl extends Test_HasRaceContextImpl implements Test_HasLegContext {

    private Test_Leg leg;
    private int legNumber;
    private Test_Competitor competitor;

    public Test_HasLegContextImpl(Test_Regatta regatta, Test_Race race, Test_BoatClass boatClass, int year,
