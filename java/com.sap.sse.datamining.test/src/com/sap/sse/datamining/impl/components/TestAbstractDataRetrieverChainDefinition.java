...
public class TestAbstractDataRetrieverChainDefinition {
    ...
    public void initializeRetrieverChain() {
        ...
        dataRetrieverChainDefinition = new AbstractDataRetrieverChainDefinition<Collection<Test_Regatta>>((Class<Collection<Test_Regatta>>)(Class<?>) Collection.class, retrievableDataTypes) {
            @Override
    ...
    public void testIncompleteDataRetrieverChainCreation() {
        List<Class<?>> retrievableDataTypes = new ArrayList<>();
        retrievableDataTypes.add(Test_Regatta.class);
        retrievableDataTypes.add(Test_HasLegOfCompetitorContext.class);
        
        //Theres a missing link between Test_Regatta and Test_HasLegOfCompetitorContext
        @SuppressWarnings("unused")
        DataRetrieverChainDefinition<Collection<Test_Regatta>> incompleteDataRetrieverChainDefinition = new AbstractDataRetrieverChainDefinition<Collection<Test_Regatta>>((Class<Collection<Test_Regatta>>)(Class<?>) Collection.class, retrievableDataTypes) {
            @Override
            protected Processor<?, ?> createRetrieverFor(Class<?> retrievedDataType, FilterCriterion<?> filter,
                    Collection<Processor<?, ?>> resultReceivers) {
                ThreadPoolExecutor executor = ConcurrencyTestsUtil.getExecutor();
    ...
    @SuppressWarnings("unchecked")
    @Test(expected=Exception.class)
    public void testDataRetrieverChainDefinitionWithIncompleteCreateRetrieverForMethdod() {
        List<Class<?>> retrievableDataTypes = new ArrayList<>();
        retrievableDataTypes.add(Test_Regatta.class);
        retrievableDataTypes.add(Test_HasRaceContext.class);
        retrievableDataTypes.add(Test_HasLegOfCompetitorContext.class);
        
        //Contains Test_HasRaceContext as retrievable data type, but can't create a retriever for it
        @SuppressWarnings("unused")
        DataRetrieverChainDefinition<Collection<Test_Regatta>> incompleteDataRetrieverChainDefinition = new AbstractDataRetrieverChainDefinition<Collection<Test_Regatta>>((Class<Collection<Test_Regatta>>)(Class<?>) Collection.class, retrievableDataTypes) {
            @Override
            protected Processor<?, ?> createRetrieverFor(Class<?> retrievedDataType, FilterCriterion<?> filter,
    ...
    @SuppressWarnings("unchecked")
    @Test(expected=Exception.class)
    public void testDataRetrieverChainDefinitionWithIncorrectCreateRetrieverForMethdod() {
        List<Class<?>> retrievableDataTypes = new ArrayList<>();
        retrievableDataTypes.add(Test_Regatta.class);
        retrievableDataTypes.add(Test_HasRaceContext.class);
        retrievableDataTypes.add(Test_HasLegOfCompetitorContext.class);
        
        //Swapped the created data retriever for the data types Test_Regatta and Test_HasRaceContext
        @SuppressWarnings("unused")
        DataRetrieverChainDefinition<Collection<Test_Regatta>> incompleteDataRetrieverChainDefinition = new AbstractDataRetrieverChainDefinition<Collection<Test_Regatta>>((Class<Collection<Test_Regatta>>)(Class<?>) Collection.class, retrievableDataTypes) {
            @Override
            protected Processor<?, ?> createRetrieverFor(Class<?> retrievedDataType, FilterCriterion<?> filter,
