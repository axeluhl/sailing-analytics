...
public class TestPartitioningOfAbstractSimpleParallelProcessor {
    ...
    public void testPartitioning() {
        Processor<Integer> processor = new AbstractSimpleParallelProcessor<Integer, Integer>(Integer.class, FunctionTestsUtil.getExecutor(), new HashSet<Processor<Integer>>()) {
            @Override
