...
public abstract class AbstractRaceLogTrackingTest {
    ...
    protected final AbstractLogEventAuthor author = new RaceLogEventAuthorImpl("author0", 0);
    protected final AbstractLogEventAuthor author1 = new RaceLogEventAuthorImpl("author1", 1);
