...
public class MainMenu extends Composite {
	...
	public void voidSetActiveLink(String pageNameToken) {
		...
		switch(pageNameToken) {
			case PageNameConstants.aboutUsPage: aboutUsPageLink.addStyleName(activeLinkStyle); break; 
			case PageNameConstants.contactPage: contactPageLink.addStyleName(activeLinkStyle); break;
			case PageNameConstants.startPage: startPageLink.addStyleName(activeLinkStyle); break; 
			case PageNameConstants.eventsPage: eventsPageLink.addStyleName(activeLinkStyle); break; 
		}
	}
