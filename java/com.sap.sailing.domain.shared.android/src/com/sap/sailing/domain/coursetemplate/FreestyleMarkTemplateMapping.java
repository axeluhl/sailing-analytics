...
/**
 * Describes a mapping with an optional {@link #getMarkTemplate() mark template} that delivers
 ...
 *
 */
public interface FreestyleMarkTemplateMapping extends MarkConfiguration {
    @Override
