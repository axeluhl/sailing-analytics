...
public class DependentStartTimeResolver {
    ...
    StartTimeFinderResult internal_resolve(RaceLogDependentStartTimeEvent event, List<SimpleRaceLogIdentifier> dependingOnRaces) {
        ...
        StartTimeFinder dependentStartTimeFinder = new StartTimeFinder(raceLogResolver, raceLog, dependingOnRaces);
        StartTimeFinderResult resultOfDependentRace = dependentStartTimeFinder.analyze();
    ...
    private boolean containsCycle(List<SimpleRaceLogIdentifier> dependingOnRaces) {
        HashSet<SimpleRaceLogIdentifier> dependingOnRacesHashSet = new HashSet<SimpleRaceLogIdentifier>(dependingOnRaces);
