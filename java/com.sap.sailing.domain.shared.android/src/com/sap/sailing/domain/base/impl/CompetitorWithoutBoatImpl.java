...
public class CompetitorWithoutBoatImpl implements DynamicCompetitor {
    ...
    public CompetitorWithoutBoatImpl(Serializable id, String name, String shortName, Color color, String email, URI flagImage, DynamicTeam team, Double timeOnTimeFactor, Duration timeOnDistanceAllowancePerNauticalMile, String searchTag) {
        this.id = id;
        this.name = name;
