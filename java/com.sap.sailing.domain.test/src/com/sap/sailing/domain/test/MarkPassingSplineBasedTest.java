...
import com.sap.sailing.domain.test.util.HermiteCurve;
import com.sap.sailing.domain.test.util.StraightLine;
import com.sap.sailing.domain.test.util.Vector2D;
