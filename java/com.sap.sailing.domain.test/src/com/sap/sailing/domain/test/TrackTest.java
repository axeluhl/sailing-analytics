...
public class TrackTest {
    ...
    public void testDistanceTraveledBackwardsQuery() {
        final Set<com.sap.sse.common.UtilNew.Triple<TimePoint, TimePoint, Distance>> cacheEntries = new HashSet<>();
        final DistanceCache distanceCache = new DistanceCache("test-DistanceCache") {
            ...
            public void cache(TimePoint from, TimePoint to, Distance distance) {
                ...
                cacheEntries.add(new com.sap.sse.common.UtilNew.Triple<>(from, to, distance));
            }
   ...
   private TimePoint addMillisToTimepoint(TimePoint p, long millis) {
    ...
    public void testDistanceTraveledOnSmoothenedTrackThenAddingOutlier() {
        ...
        final com.sap.sse.common.UtilNew.Pair<TimePoint, com.sap.sse.common.UtilNew.Pair<TimePoint, Distance>> fullIntervalCacheEntry = distanceCache.getEarliestFromAndDistanceAtOrAfterFrom(now,  start);
        ...
        final com.sap.sse.common.UtilNew.Pair<TimePoint, com.sap.sse.common.UtilNew.Pair<TimePoint, Distance>> newFullIntervalCacheEntry = distanceCache
        ...
        final com.sap.sse.common.UtilNew.Pair<TimePoint, com.sap.sse.common.UtilNew.Pair<TimePoint, Distance>> stillPresentFullIntervalCacheEntry = distanceCache
                .getEarliestFromAndDistanceAtOrAfterFrom(now, timePointOfLastOriginalFix);
        ...
        final com.sap.sse.common.UtilNew.Pair<TimePoint, com.sap.sse.common.UtilNew.Pair<TimePoint, Distance>> stillStillPresentFullIntervalCacheEntry = distanceCache
                .getEarliestFromAndDistanceAtOrAfterFrom(now, timePointOfLastOriginalFix);
    ...
    public void testDistanceCacheAccessForPartialStrip() {
        ...
        com.sap.sse.common.UtilNew.Pair<TimePoint, com.sap.sse.common.UtilNew.Pair<TimePoint, Distance>> stripCacheEntry = distanceCache.getEarliestFromAndDistanceAtOrAfterFrom(stripFrom, stripTo);
        ...
        com.sap.sse.common.UtilNew.Pair<TimePoint, com.sap.sse.common.UtilNew.Pair<TimePoint, Distance>> fullCacheEntry = distanceCache.getEarliestFromAndDistanceAtOrAfterFrom(now, start);
    ...
    public void testInvalidationIntervalBeginningForPositionEstimation() {
        ...
        com.sap.sse.common.UtilNew.Pair<TimePoint, TimePoint> intervalAffected = track.getEstimatedPositionTimePeriodAffectedBy(newFirstFix);
    ...
    public void testInvalidationIntervalEndForPositionEstimation() {
        ...
        com.sap.sse.common.UtilNew.Pair<TimePoint, TimePoint> intervalAffected = track.getEstimatedPositionTimePeriodAffectedBy(newLastFix);
    ...
    public void testInvalidationIntervalForPositionEstimationForEmptyTrack() {
        ...
        com.sap.sse.common.UtilNew.Pair<TimePoint, TimePoint> intervalAffected = myTrack.getEstimatedPositionTimePeriodAffectedBy(newFix);
