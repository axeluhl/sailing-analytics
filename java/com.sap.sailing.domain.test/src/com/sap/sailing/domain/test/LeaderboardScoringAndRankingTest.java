...
public class LeaderboardScoringAndRankingTest extends AbstractLeaderboardTest {
    ...
    public void testAdditionalScoreInformationLeadsToChangedScoreForOneColumn() throws NoWindException {
        ...
        raceLogForRace2.add(new AdditionalScoringInformationEventImpl(now, new AbstractLogEventAuthorImpl("Plopp", 1), later, "12345678", Collections.<Competitor>emptyList(), 0, AdditionalScoringInformationType.UNKNOWN));
        assertEquals(new Double(20), leaderboardHighPoint10Or8AndLastBreaksTie.getTotalPoints(competitors[0], later));
        assertEquals(new Double(18), leaderboardHighPoint10Or8AndLastBreaksTie.getTotalPoints(competitors[1], later));
        assertEquals(new Double(2), leaderboardHighPoint10Or8AndLastBreaksTie.getTotalPoints(competitors[9], later));
        raceLogForRace2.add(new AdditionalScoringInformationEventImpl(now, new AbstractLogEventAuthorImpl("Plopp", 1), later.plus(Duration.ONE_MINUTE), "123456789873773762", Collections.<Competitor>emptyList(), 0, AdditionalScoringInformationType.MAX_POINTS_DECREASE_MAX_SCORE));
        ...
        assert event != null;
        try {
            raceLogForRace2.revokeEvent(new AbstractLogEventAuthorImpl("Plopp", 1), event);
        ...
        assertEquals(new Double(3), leaderboardHighPoint10Or8AndLastBreaksTie.getTotalPoints(competitors[9], later));
        RaceState raceStateForRace2 = RaceStateImpl.create(raceLogForRace2, new AbstractLogEventAuthorImpl("Simon", 1));
