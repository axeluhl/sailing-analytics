...
public class AddSpecificRegatta extends AbstractAddRegattaOperation {
    ...
    private final Map<String, Triple<List<Triple<String, Integer, Color>>, Boolean, int[]>> seriesNamesWithFleetNamesAndFleetOrderingAndMedalAndDiscardingThresholds;
    ...
    public AddSpecificRegatta(String regattaName, String boatClassName, Serializable id,
            Map<String, Triple<List<Triple<String, Integer, Color>>, Boolean, int[]>> seriesNamesWithFleetNamesAndFleetOrderingAndMedalAndDiscardingThresholds,
            boolean persistent, ScoringScheme scoringScheme, Serializable defaultCourseAreaId) {
        super(regattaName, boatClassName, id);
        this.seriesNamesWithFleetNamesAndFleetOrderingAndMedalAndDiscardingThresholds = seriesNamesWithFleetNamesAndFleetOrderingAndMedalAndDiscardingThresholds;
    ...
    private Iterable<? extends Series> createSeries(TrackedRegattaRegistry trackedRegattaRegistry) {
        ...
        for (Map.Entry<String, Triple<List<Triple<String, Integer, Color>>, Boolean, int[]>> e : seriesNamesWithFleetNamesAndFleetOrderingAndMedalAndDiscardingThresholds.entrySet()) {
