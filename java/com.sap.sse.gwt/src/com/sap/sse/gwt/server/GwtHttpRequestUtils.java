...
public abstract class GwtHttpRequestUtils {
    ...
    public static int[] getIntParameters(String name) {
        try {
            return getRequiredIntParameters(name);
        } catch (ParseHttpParameterException ex) {
            return new int[0];
        }
    }
    ...
    public static int getRequiredIntParameter(String name) throws ParseHttpParameterException {
        return INT_PARSER.parseInt(name, Window.Location.getParameter(name));
    }
    ...
    public static int[] getRequiredIntParameters(String name) throws ParseHttpParameterException {
        return INT_PARSER.parseInts(name, Window.Location.getParameterMap().get(name));
    }
    ...
    public static String getStringParameter(String name, String defaultValue) {
        String val = Window.Location.getParameter(name);
    ...
    public static String[] getRequiredStringParameters(String name) throws ParseHttpParameterException {
        return STRING_PARSER.validateRequiredStrings(name, Window.Location.getParameterMap().get(name));
    }
    ...
    private static class IntParser extends ParameterParser {
        ...
        public int[] parseInts(String name, List<String> values) throws ParseHttpParameterException {
            ...
            for (int i = 0; i < values.size(); i++) {
                parameters[i] = parseInt(name, values.get(i));
            }
            return parameters;
        }
    }
    ...
    private static class LongParser extends ParameterParser {
        ...
        public long[] parseLongs(String name, List<String> values) throws ParseHttpParameterException {
            ...
            for (int i = 0; i < values.size(); i++) {
                parameters[i] = parseLong(name, values.get(i));
            }
            return parameters;
        }
    }
    ...
    private static class FloatParser extends ParameterParser {
        ...
        public float[] parseFloats(String name, List<String> values) throws ParseHttpParameterException {
            ...
            for (int i = 0; i < values.size(); i++) {
                parameters[i] = parseFloat(name, values.get(i));
            }
            return parameters;
        }
    }
    ...
    private static class DoubleParser extends ParameterParser {
        ...
        public double[] parseDoubles(String name, List<String> values) throws ParseHttpParameterException {
            ...
            for (int i = 0; i < values.size(); i++) {
                parameters[i] = parseDouble(name, values.get(i));
            }
            return parameters;
        }
    }
    ...
    private static class BooleanParser extends ParameterParser {
        ...
        public boolean[] parseBooleans(String name, List<String> values) throws ParseHttpParameterException {
            ...
            for (int i = 0; i < values.size(); i++) {
                parameters[i] = parseBoolean(name, values.get(i));
            }
            return parameters;
        }
    }
    ...
    private static class StringParser extends ParameterParser {
        ...
        public String[] validateRequiredStrings(String name, List<String> values) throws ParseHttpParameterException {
            ...
            for (int i = 0; i < values.size(); i++) {
                parameters[i] = validateRequiredString(name, values.get(i));
            }
            return parameters;
        }
    }
