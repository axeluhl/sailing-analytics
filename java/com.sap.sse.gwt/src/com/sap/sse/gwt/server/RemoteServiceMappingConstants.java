...
public interface RemoteServiceMappingConstants {
     ...
     */
    public static final String WEB_CONTEXT_PATH = "gwt-base";
    
    public static final String crossDomainStorageConfigurationServiceRemotePath = "service/crossdomainstorageconfiguration";
}
