...
/**
 * A {@link TableWrapperWithFilter} that supports single selection (selecting at most one element in the table).
 * 
 ...
 */
public abstract class TableWrapperWithSingleSelectionAndFilter<T, SM extends StringMessages, TR extends CellTableWithCheckboxResources>
extends TableWrapperWithFilter<T, RefreshableSingleSelectionModel<T>, SM, TR> {
    public TableWrapperWithSingleSelectionAndFilter(SM stringMessages, ErrorReporter errorReporter,
    ...
    public TableWrapperWithSingleSelectionAndFilter(SM stringMessages, ErrorReporter errorReporter,
            ...
            String filterCheckboxLabel) {
        super(stringMessages, errorReporter, /* multiSelection */ false, enablePager, entityIdentityComparator, tableRes,
