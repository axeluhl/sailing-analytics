 ...
 * elements with {@link EntityIdentityComparator#representSameEntity(Object, Object) the same identity} will be reselected.
 * 
 * @param <T>
 *            the type of {@link CellTable} entries
 */
public class RefreshableMultiSelectionModel<T> extends MultiSelectionModel<T> implements RefreshableSelectionModel<T>, HasData<T> {
     ...
     */
    public RefreshableMultiSelectionModel(EntityIdentityComparator<T> comp, ListDataProvider<T> provider) {
        super();
        this.comp = comp;
     ...
     *            {@link ListDataProvider} to register this as listener and get the entries
     */
    public RefreshableMultiSelectionModel(ProvidesKey<T> keyProvider, EntityIdentityComparator<T> comp, ListDataProvider<T> provider) {
        super(keyProvider);
        this.comp = comp;
        this.provider = provider;
        if (this.provider != null) {
