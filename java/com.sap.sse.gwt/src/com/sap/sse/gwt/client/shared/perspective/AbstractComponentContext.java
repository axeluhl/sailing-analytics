...
/**
 * Manages all default settings of perspectives and components.
 * This abstract implementation has no support for settings storage. It is only capable
 * of creating new default settings by means of {@link ComponentLifecycle} of the root
 * component managed by this {@link ComponentContext}. All in all, it is a dummy
 * implementation for components which do not have support for settings storage.
 * If you need settings storage support, consider {@link AbstractComponentContextWithSettingsStorage}.
 * 
...
public abstract class AbstractComponentContext<L extends ComponentLifecycle<S, ?>, S extends Settings> implements ComponentContext<L, S> {
    ...
    /**
     * This operation is unsupported for this abstract implementation and will throw a {@link UnsupportedOperationException}
     * when it is called.
     */
    @Override
    ...
    /**
     * This method returns always {@code false}, because it does not offer
     * functionality for settings storage.
     */
    @Override
