 ...
 **/
public class ComponentAndSettingsPair<SettingsType extends Settings> implements Serializable {
    ...
    public ComponentAndSettingsPair(Component<SettingsType> component, SettingsType settings) {
