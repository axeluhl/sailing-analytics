 ...
 * 
 * Mostly copied from {@link TabLayoutPanel}. See copyright above.
 */
public class VerticalTabLayoutPanel extends ResizeComposite implements HasWidgets,
  ...
  private class Tab extends SimplePanel {
    ...
    public boolean remove(Widget w) {
      ...
      if (replacingWidget || index < 0) {
        ...
        return VerticalTabLayoutPanel.this.remove(index);
      }
    }
  ...
  private class TabbedDeckLayoutPanel extends DeckLayoutPanel {
    ...
    public boolean remove(Widget w) {
       ...
       */
      return VerticalTabLayoutPanel.this.remove(w);
    }
  ...
  private static final String CONTENT_CONTAINER_STYLE = "gwt-VerticalTabLayoutPanelContentContainer";
  private static final String CONTENT_STYLE = "gwt-VerticalTabLayoutPanelContent";
