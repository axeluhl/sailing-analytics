...
then
        ...
        then
                ...
                then
                        #set production to failover if not already. Separate if statement in case the curl statement fails but for some reason the production is already set to point to the backup
