...
SERVER_NAME=HSC
DEPLOY_TO=hsc
MONGODB_URI="mongodb://mongo0.internal.sapsailing.com,mongo1.internal.sapsailing.com/HSC?replicaSet=live&retryWrites=true&readPreference=nearest"
EXPEDITION_PORT=2010
SERVER_PORT=8888
TELNET_PORT=14888
REPLICATION_CHANNEL=HSC
