...
DEPLOY_TO=isr
SERVER_NAME=ISR
REPLICATION_CHANNEL=ISR
SERVER_PORT=8902
#MONGODB_URI="mongodb://dbserver.internal.sapsailing.com:10202/ISR?replicaSet=slow&retryWrites=true&readPreference=nearest&connectTimeout=120&readTimeout=120"
#MONGODB_URI="mongodb://172.31.5.90,dbserver.internal.sapsailing.com:10202/ISR?replicaSet=slow&retryWrites=true&readPreference=nearest&connectTimeout=120&readTimeout=120"
MONGODB_URI="mongodb://mongo0.internal.sapsailing.com,mongo1.internal.sapsailing.com/ISR?replicaSet=live&retryWrites=true&readPreference=nearest&connectTimeout=120&readTimeout=120"
